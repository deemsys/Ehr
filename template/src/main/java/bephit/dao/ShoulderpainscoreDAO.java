...
public class ShoulderpainscoreDAO {
	...
	public int setShoulderpain(Shoulderpainscore shoulderpainscore,Principal principal)
	{
		Connection con = null;
