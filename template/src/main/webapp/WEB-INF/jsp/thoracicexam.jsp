...
<td valign="top" align="left">
 ...
 <tr class="row1">
<td style="width: 261px; "><h4><span class="err">*</span>Patient Name:</h4></td><td style="width: 284px; "><input type="text"  name="pname" id="pname"/><span class="err" id="pnameerror"><form:errors path="Thoracicexam.pname"></form:errors></span></td>
...
<br/>
 ...
 <td>  </td><td>   <b>Left</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b> Right</b></td>
  ...
  <tr class="row1">
 <td><b>Flexion:</b> </td><td> (20-40)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="flexion" size="7" onkeypress="return validate(event)"></td> 
 <td width="100">T1-2:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="t12" size="7" onkeypress="return validate(event)"></td><td width="250">T2-3:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="t23" size="7" onkeypress="return validate(event)"> </td> 
 <td><b>Adam's Sign:	</b> </td><td><input type="text" name="adamsignl" size="5" onkeypress="return validate(event)"> <input type="text" name="adamsignr" size="5" onkeypress="return validate(event)"></td>
 </tr>
  <tr class="row1">
 <td><b>Extension:	</b> </td><td> (25-45)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="extension" size="7" onkeypress="return validate(event)"></td> 
 <td width="100">T3-4:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="t34" size="7" onkeypress="return validate(event)"></td><td width="50">T4-5:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="t45" size="7" onkeypress="return validate(event)"> </td> 
 <td><b>Schepelman's:	</b> </td><td><input type="text" name="schepelmanl" size="5" onkeypress="return validate(event)"> <input type="text" name="schepelmanr" size="5" onkeypress="return validate(event)"></td>
 </tr>
  <tr class="row1">
 <td><b>Lateral Flexion:</b> </td><td> (20-40)&nbsp;&nbsp;&nbsp;L <input type="text" name="lflexion" size="7" onkeypress="return validate(event)"><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;R <input type="text" name="rflexion" size="7" onkeypress="return validate(event)"></td> 
 <td width="100">T5-6:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="t56" size="7" onkeypress="return validate(event)"></td><td width="50">	T6-7:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	<input type="text" name="t67" size="7" onkeypress="return validate(event)"> </td> 
 <td><b>Valsalva:</b> </td><td><input type="text" name="valsalval" size="5" onkeypress="return validate(event)"> <input type="text" name="valsalvar" size="5" onkeypress="return validate(event)"> </td>
 </tr>
  <tr class="row1">
  <td><b>Rotation:</b> </td><td> (35-50)&nbsp;&nbsp;&nbsp;L <input type="text" name="lrotation" size="7" onkeypress="return validate(event)"><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;R <input type="text" name="rrotation" size="7" onkeypress="return validate(event)"></td> 
 <td width="100">T7-8:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	<input type="text" name="t78" size="7" onkeypress="return validate(event)"></td><td width="50">T8-9:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="t89" size="7" onkeypress="return validate(event)"> </td> 
 <td><b>Dejerine's Triad:</b> </td><td><input type="text" name="dejerinel" size="5" onkeypress="return validate(event)"> <input type="text" name="dejeriner" size="5" onkeypress="return validate(event)"></td>
 </tr>
  <tr class="row1">
 <td></td><td> </td> 
 <td width="100">T9-10:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="t910" size="7" onkeypress="return validate(event)"></td><td width="50">T10-11:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="t1011" size="7" onkeypress="return validate(event)"> </td> 
...
<td width="250">6)<input type="text" name="diagnosis6"></td>
 ...
 <br/>
 <table><tr><td><B style="font-size:14px"><span class="err">*</span>PHYSICIAN SIGNATURE: &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="sign" id="sign"><span class="err" id="signerror"><form:errors path="Thoracicexam.sign"></form:errors></span></B></td></tr></table>
<table align="right">
<tr>
