...
<script>
  ...
  $(function() {
	...
	<div id="tabs" class="tabs-bottom">
	  ...
	  <div id="tabs-1">
			<div id="right_content">
				<form action="updateadminpatientdetails" method="post" name="update" id="update">
				...
				function addMultichoice(divName) {
					...
					newdiv.innerHTML = '<table width="100%" border="0" cellspacing="0" cellpadding="0" id="newtbl'
							...
							+ $in
							+ ' :</td><td valign="top" align="left" class="input_txt" width="70%"><textarea name="message[]" rows="5" cols="" id="inp_id5">hello</textarea></td></tr><tr class="row1"><td align="right" valign="top">&nbsp;</td><td align="left" valign="top"><a javascript:void(0);" onclick="removechoice('
							+ $im
   ...
   <td width="510"></td><td><div id="multi"></div> <a href="javascript:void(0);" onclick="addMultichoice('multi');" style="text-decoration:none;" ><input type="button" value="Add one more Symptom" class="submit_btn2" name=""/></a></td>
