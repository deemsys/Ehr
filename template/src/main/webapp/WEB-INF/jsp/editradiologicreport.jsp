                						...
                						<td  width="150" valign="middle" align="left" class="input_txt"><span class="err">*</span>Views:
						                    ...
						                    <option value="A-P lower" <c:if test="${radiologicReport.views1=='A-P lower'}"><c:out value="selected"/></c:if>>A-P lower</option>
						                     ...
						                     <option value="Ext" <c:if test="${radiologicReport.views1=='Ext'}"><c:out value="selected"/></c:if>>Ext</option>
												...
												<td valign="top" align="left" class="input_txt" width="400" ><input type="checkbox"  value="Negative for Osteopathology" name="negative_1" <c:if test="${radiologicReport.negative_1=='Negative for Osteopathology'}"><c:out value="Checked"/></c:if>   />Negative for recent fracture, dislocation or gross Osteopathology</td>							                    
						                     	<td></td>
						                     	<td></td>	
						                     </tr>
						                     <tr class="row2">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
				               <tr class="row1">
						                    ...
						                    <option value="llf" <c:if test="${radiologicReport.views2=='llf'}"><c:out value="selected"/></c:if>>LLF</option>
						                     ...
						                     <td valign="top" align="left" class="input_txt" width="400"><input type="checkbox"  value="Negative for Osteopathology" name="negative_2" <c:if test="${radiologicReport.negative_2=='Negative for Osteopathology'}"><c:out value="Checked"/></c:if>   />Negative for recent fracture, dislocation or gross Osteopathology</td>
						                     <td></td>
						                     <td></td>
						         </tr>
						         <tr class="row2">
              ...
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
  				<tr class="row1">
					...
					<tr class="row1">
								...
								<tr class="row2">  
										<td valign="top" align="left" class="input_txt" width="380"><input type="checkbox"  value="Anterior osteophytes at" name="anterior_3" id="anterior3check" onclick="Anterior3();" <c:if test="${radiologicReport.anterior_3=='Anterior osteophytes at'}"><c:out value="Checked"/></c:if>   />Anterior vertebral body osteophytes at
						                                <input type="text" class="input_txtbx1" id="anterior3"  value="${radiologicReport.anterior_text3 }" style='display:none'  name="anterior_text3" /><span class="err"><form:errors path="report.anterior_text3"></form:errors></span>
						                     			...
						                     			<td valign="top" align="left" class="input_txt" width="380"><input type="checkbox"  value="Subchondral sclerosis of" name="subchondral_3" id="subchondral3check" onclick="Subchondral3();"<c:if test="${radiologicReport.subchondral_3=='Subchondral sclerosis of'}"><c:out value="Checked"/></c:if>   />Subchondral sclerosis of
						                     		...
						                     		<td valign="top" align="left" class="input_txt" width="380"><input type="checkbox"  value="Schmorls nodes at:" name="schmorls_3"id="schmorlsnodes3"onclick="Schmorls3();" <c:if test="${radiologicReport.schmorls_3=='Schmorls nodes at:'}"><c:out value="Checked"/></c:if>   />Schmorl's nodes at:
						                         ...
						                         <tr class="row1">
						                         		<td valign="top" align="left" class="input_txt" width="480"><input type="checkbox"  value="Spondylolisthesis of" name="spondylolisthesisof_3" id="spondylolisthesisof3check" onclick="Spondylolisthesisof3();" <c:if test="${radiologicReport.spondylolisthesisof_3=='Spondylolisthesis of'}"><c:out value="Checked"/></c:if>   />Spondylolisthesis of
						                ...
						                <td width="380">Other:<input type="text" class="input_txtbx1" id="inp_id" onmouseover="showTooltip('tooltip_id','inp_id3');" onmouseout="hideTooltip('tooltip_id');" value="${radiologicReport.other_text3 }" name="other_text3" /></br><span class="err"><form:errors path="report.other_text3"></form:errors></span></td>
