 ...
 <div>
	     ...
	     <div class="contentbox">
          ...
          <table cellpadding="0" cellspacing="0" border="0" >
           ...
           <table >
           <tr><td><b>Gait:</b>&nbsp;</td>  <td><c:out value="${footexamdetails.gait}"></c:out></td>
...
<tr height="10"></tr>
           ...
           <td><c:out value="${footexamdetails.muscle}"></c:out></td><td width="10"></td>
             <td width="130">Swelling  / Discoloration</td>
             <td width="40"><c:out value="${footexamdetails.swelling}"></c:out></td>
           
           <td width="59"></td>
           <td width="120">A & O</td><td><c:out value="${footexamdetails.ao}"></c:out></td>
           </tr>  
           </table> 
           </br>  
           <table>
           ...
           <td width="130"><b>Supination:</b></td><td><c:out value="${footexamdetails.supination}"></c:out></td>&nbsp;&nbsp;&nbsp;<td width="110"> </td>
           <td width="35"></td>
...
<table>	
	...
	<table  style="border:10">      
         ...
         <tr height="10"></tr>
         <tr><td><b>Plantar Flexion::</b>		</td><td>50</td><td><c:out value="${footexamdetails.plantarflexionleft}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.plantarflexionright}" /></td><td width="90"></td><td><b>Tinel's Tap:</b>	</td><td width="150"></td><td><c:out value="${footexamdetails.tinelstapleft}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.tinelstapright}"/></td></tr>
         <tr><td><b>Dorsiflexion:</b>			</td><td>20</td><td><c:out value="${footexamdetails.dorsiflexionleft}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.dorsiflexionright}"/></td><td width="90"></td><td><b>Achilles Tap:</b></td><td width="150"></td><td><c:out value="${footexamdetails.achillestapleft}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.achillestapright}"/></td></tr>
         <tr><td><b>Inversion:</b>				</td><td>35</td><td><c:out value="${footexamdetails.inversionleft}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.inversionright}"/></td><td width="90"></td><td><b>Long / Transv Arch:</b></td><td width="150"></td><td><c:out value="${footexamdetails.longleft}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.longright}"/></td></tr>
         <tr><td><b>Eversion:	</b>			</td><td>15</td><td><c:out value="${footexamdetails.eversionleft}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.eversionright}" /></td><td width="90"></td><td><b>Thompson's:</b></td><td width="150"></td><td><c:out value="${footexamdetails.thompsonsleft}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.thompsonsright}" /></td></tr></tr>
         <tr><td><b>Great Toe Extension:</b></td><td>70</td><td><c:out value="${footexamdetails.greattoeextensionleft}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.greattoeextensionright}" /><td width="90"></td><td><b>Drawer:</b>	</td><td width="150"></td><td><c:out value="${footexamdetails.drawerleft}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.drawerright}" /></td></td></tr>
         <tr><td><b>Great Toe Flexion:</b></td><td>45</td><td><c:out value="${footexamdetails.greattoeflexionleft}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.greattoeflexionright}" /></td><td width="90"></td><td><b>	Lateral (Varus) Stability:</b></td><td width="150"></td><td><c:out value="${footexamdetails.lateralleft}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.lateralright}"/></td></tr>
          <tr><td></td><td></td><td>&nbsp;&nbsp;</td><td width="90"></td><td><b>Medial (Valgus) Stability:</b></td><td width="150"></td><td><c:out value="${footexamdetails.medialstabilityleft}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.medialstabilityright}" /></td></tr>
         </table>
         </td></tr></table></div></div>
        <div id="tabs-2">     
...
<td valign="top" align="left">
 <div>
        ...
        <tr>
         ...
         <td width="246"><c:out value="${footexamdetails.neurological}"/></td>
          ...
          <tr height="10"></tr>
           <tr><td><b>L1</b></td><td><c:out value="${footexamdetails.inguinalarealeft}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.inguinalarearight}" />&nbsp;&nbsp; (Inguinal area)</td><td><b>L1</b></td><td><c:out value="${footexamdetails.iliopsoasfirstleft}" />/5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.iliopsoasfirstright}"/>/5&nbsp;&nbsp; (Iliopsoas)</td><td></td><td></td></tr>
           <tr><td><b>L2</b></td><td><c:out value="${footexamdetails.antleft}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.antright}" />&nbsp;&nbsp;(Ant/med thigh)</td><td><b>L2</b></td><td><c:out value="${footexamdetails.iliopsoas1left}" />/5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.iliopsoas1right}" />/5&nbsp;&nbsp;(Iliopsoas)</td><td></td><td>&nbsp;(2+/5 is Normal)</td></tr>
           <tr><td><b>L3</b></td><td><c:out value="${footexamdetails.kneeleft}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.kneeright}" />&nbsp;&nbsp;(Medial knee)</td><td><b>L3</b></td><td><c:out value="${footexamdetails.kneeextensionleft}" />/5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.kneeextensionright}" />/5&nbsp;&nbsp;(Knee extension)</td><td></td><td>&nbsp; </td></tr>
           <tr><td><b>L4</b></td><td><c:out value="${footexamdetails.medialleft}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.medialright}" />&nbsp;&nbsp;(Medial leg)</td><td><b>L4</b></td><td><c:out value="${footexamdetails.kneeflexionleft}" />/5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.kneeflexionright}"  />/5&nbsp;&nbsp;(Knee flexion)</td><td><b>L4</b></td><td><c:out value="${footexamdetails.patellarleft}" />/5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.patellarright}" />/5&nbsp;&nbsp;Patellar</td></tr>
            <tr><td><b>L5</b></td><td><c:out value="${footexamdetails.latleft}"   />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.latright}" />&nbsp;&nbsp;(Ant/lat leg)</td><td><b>L5</b></td><td><c:out value="${footexamdetails.dorsiflexionleft1}"/>/5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.dorsiflexionright1}" />/5&nbsp;&nbsp;(Dorsiflexion)</td><td><b>L5</b></td><td><c:out value="${footexamdetails.hsleft}" />/5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.hsright}"/>/5Med HS</td></tr>
            <tr><td><b>S1</b></td><td><c:out value="${footexamdetails.plantarleft}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.plantarright}" />&nbsp;&nbsp;(Big toe/plantar)</td><td><b>S1</b></td><td><c:out value="${footexamdetails.pfleft}"/>/5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.pfright}"/>/5&nbsp;&nbsp;(Grt toe ext, PF)</td><td><b>S1</b></td><td><c:out value="${footexamdetails.achillesleft}"/>/5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${footexamdetails.achillesright}"/>/5&nbsp;&nbsp;Achilles</td></tr>
