        ...
        <td valign="top" align="center">
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
             ...
             <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <td ><td><input type="hidden" name="letterid" value="${letterofprotectiondetails.letterid }"><input type="text" class="input_txtbx1" name="date" value="${letterofprotectiondetails.date }" id="datepicker" /><span class="err"><form:errors path="Hardshipagreement.date"></form:errors></td>
              </tr>
              </table>
               <br><br><br>
              ...
              <td  height="20" ><input type="text" class="input_txtbx1" name="dear" value="${letterofprotectiondetails.dear }" id="address" /><span class="err"><form:errors path="noticeofassignment.address"></form:errors>
           </span></td></tr>	
             </table>
