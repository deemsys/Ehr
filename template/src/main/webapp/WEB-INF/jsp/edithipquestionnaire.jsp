...
<td valign="top" align="left">
 <div>
	    ...
	    <tr><td width="170" style= "border:2px solid;"></td><td width="150" valign="top" style= "border:2px solid;" align="center"><b>Not painful</b></td><td width="150" valign="top" style= "border:2px solid;" align="center"><b>Mildly painful</b></td><td width="150" valign="top" style= "border:2px solid;" align="center"><b>Moderately painful</b></td><td width="150" valign="top" style= "border:2px solid;" align="center"><b>very painful</b></td><td width="150" valign="top" style= "border:2px solid;" align="center"><b>Extremely painful</b></td><td width="150" valign="top" style= "border:2px solid;"><b>Could not do because of hip/knee pain</b></td><td valign="top" style= "border:2px solid;"><b>Could not do for other reasons</b></td></tr>
	     ...
	     <tr><td style= "border:1px solid;">Left Knee</td><td style= "border:1px solid;" align="center"><input type="radio" name="bedleftknee" value="1" <c:if test="${hipquestionnairedetails.bedleftknee=='1'}"> <c:out value="checked"></c:out></c:if>>&nbsp;1</td><td style= "border:1px solid;" align="center"><input type="radio" name="bedleftknee" value="2" <c:if test="${hipquestionnairedetails.bedleftknee=='2'}"> <c:out value="checked"></c:out></c:if> >&nbsp;2</td><td style= "border:1px solid;" align="center"><input type="radio" name="bedleftknee" value="3" name="bedleftknee" <c:if test="${hipquestionnairedetails.bedleftknee=='3'}"> <c:out value="checked"></c:out></c:if>  >&nbsp;3</td><td style= "border:1px solid;" align="center"><input type="radio" name="bedleftknee" value="4" <c:if test="${hipquestionnairedetails.bedleftknee=='4'}"> <c:out value="checked"></c:out></c:if>  >&nbsp;4</td><td style= "border:1px solid;" align="center"><input type="radio" name="bedleftknee" value="5" <c:if test="${hipquestionnairedetails.bedleftknee=='5'}"> <c:out value="checked"></c:out></c:if> >&nbsp;5</td><td style= "border:1px solid;" align="center"><input type="radio" name="bedleftknee" value="6" <c:if test="${hipquestionnairedetails.bedleftknee=='6'}"> <c:out value="checked"></c:out></c:if> >&nbsp;6</td><td style= "border:1px solid;" align="center"><input type="radio" name="bedleftknee" value="7" <c:if test="${hipquestionnairedetails.bedleftknee=='7'}"> <c:out value="checked"></c:out></c:if> >&nbsp;7</td></tr>
	     </table>
          <p><b>&nbsp;6.Which  of the following statements best describes your ability to get around most of the time during the past week?</b></p>
              ...
              <tr><td><input type="radio" name="best" <c:if test="${hipquestionnairedetails.best=='I mostly used two canes, two crutches or a walker to help me get around.'}"> <c:out value="checked"></c:out></c:if> value="I mostly used two canes, two crutches or a walker to help me get around.">I mostly used two canes, two crutches or a walker to help me get around.<tr><td><input type="radio" name="best" <c:if test="${hipquestionnairedetails.best=='I did not need support or assitance at all.'}"> <c:out value="checked"></c:out></c:if>="" value="I did not need support or assitance at all.">I did not need support or assitance at all.</td></td></tr>
...
<td valign="top" align="left">
 <div>
	    ...
	    <br><br>
	   <span class="err">* </span> Your Social Security Number: <input type="text" name="security" id="security" placeholder="987-65-4320"  onkeypress="return validate(event)"; maxlength="11" value="${hipquestionnairedetails.security}" class="input_txtbx1" style="width: 200px; "><br><span style="color: red;font-style:italic;" id="securityerror"></span>
	    <div id="number">
	    <br>
	    <br>
	    <br>
