      ...
      <tr>
        <td valign="top" align="center">
        	<div>
              ...
              <td ><input type="text" class="input_txtbx1" name="ssn" id="ssn" maxlength="11" value="${lettertopatientsdetails.ssn }" onkeypress="return isNumberKey(event);"/><span class="err" id="ssnerror"><form:errors path="Workschool.date"></form:errors></span></td>
              </tr>
              </table>
               <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              ...
              <td ><input type="text" class="input_txtbx1" name="date" id="datepicker3" value="${lettertopatientsdetails.date }" /><span class="err" id="datepicker3error"></span><form:errors path="Workschool.date"></form:errors></span></td>
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="120">Dear</td>
              <td ><input type="text" class="input_txtbx1" name="dear" id="dear" value="${lettertopatientsdetails.dear }" /><span class="err"><form:errors path="Workschool.date"></form:errors></span></td>
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
