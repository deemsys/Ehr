				     ...
				     <tr class="title">
						...
						<c:if test="${fn:length(elbowexamForm.elbowexam) gt 0}">
        				  <c:forEach items="${elbowexamForm.elbowexam}" var="elbowexam" varStatus="status">
								        ...
								        <td valign="top" align="left"  width="10%"> <a href="elbowexamlist?elbowexamid=${elbowexam.elbowexamid}">${elbowexam.pname}</a></td>
											<td valign="top" align="left" width="15%">${elbowexam.date}</td>
											
												<td valign="top" align="left">
											<%--  <c:if test="${currentuser.adminuser[0].editradiologicreport==1}"> --%>
												<a href="#" title="" ><img src="resources/images/icons/icon_edit.png" alt="Edit" /></a><a href="<c:out value="editelbowlist?elbowexamid=${elbowexam.elbowexamid}"/>" style="padding-right:10px;">Edit</a>
											<%-- 	 </c:if>
