				     ...
				     <tr class="title">
						...
						<c:if test="${fn:length(HippaPrivacyForm.privacyDetails) gt 0}">
        				  <c:forEach items="${HippaPrivacyForm.privacyDetails}" var="privacydetails" varStatus="status">
											...
											<a href="#" title=""><img src="resources/images/icons/icon_delete.png" alt="Delete" /></a><a href="<c:out value="deletehippaprivacydetails?hippa_no=${privacydetails.hippa_no}"/>" onclick="return confirmation()">Remove</a>
											</td>
