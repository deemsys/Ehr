...
public class PatientDAO {
	...
	public int setPatientDetails(PatientDetails patientdetails,String[] Symptoms,Principal principal)
	{
	    ...
	    try{
	    	 ...
	    	 int noofRecords=0;
				...
				patientrecords = "select count(*) as noofrecords from patient_details";
	...
	public List<PatientDetails> getUsername(Principal admin){
	    ...
	    try{
			resultSet = statement.executeQuery("select * from patient_details where Name='"+admin.getName()+"'");
