...
Claimant was involved in an accident on or about the <input type="text" class="input_txtbx1" id="day1" name="day1"  onInput="return validatename(id)";/><span id="day1error" style="color: red;font-style:italic;"><form:errors path="Assignment.day1"></form:errors></span>
day of <input type="text" class="input_txtbx1" id="month1" name="month1"  onInput="return validatename(id)";/> <span id="month1error" style="color: red;font-style:italic;"><form:errors path="Assignment.month1"></form:errors></span>and I therein incurred injuries for which I have sought medical treatment from PCTC.</p>
 ...
 testimony, and any other charges incurred by me at PCTC.
  ...
  <p id="mypar"> Claimant grants a contractual lien to Perry Chiropractic and Therapy Center with respect to my charges. Compliance herewith is requisite with notice by facsimile, letter, or telephone contact. 
                       ...
                       <tr class="row1">
				                  ...
				                  <td valign="top" align="left" class="input_txt">
				                  	<input type="text" class="input_txtbx1" id="patientsign" name="patientsign" onInput="return validatesign(id);"/><br><span id="patientsignerror" style="color: red;font-style:italic;"><form:errors path="Assignment.patientsign"></form:errors></span>
				                  ...
				                  <td valign="top" align="left" class="input_txt">
				                  	<input type="text" class="input_txtbx1" id="parentsign" name="parentsign" onInput="return validatesign(id);"/><br><span id="parentsignerror" style="color: red;font-style:italic;"></span><form:errors path="Assignment.parentsign"></form:errors>
				                  ...
				                  <td valign="top" align="left" class="input_txt">
				                  	<input type="text" class="input_txtbx1" id="representative" name="representative" onInput="return validatename(id);"/><br><span id="representativeerror" style="color: red;font-style:italic;"> </span><form:errors path="Assignment.representative"></form:errors>
				                  	<td valign="middle" align="left" class="input_txt"><span class="err">* </span>Date:  </td>
				                  <td valign="middle" align="left" class="input_txt">
				                  	...
				                  	<form:errors path="Assignment.representativedate"></form:errors></span></td>
				                  	</tr>
				                  	</table>
				                  	</c:when>
				                  	<c:otherwise>
...
and exclusively in the name of Perry Chiropractic and Therapy Center, such sums as may be owing to PCTC, for charges
 ...
 testimony, and any other charges incurred by me at PCTC.
  ...
  <p id="mypar"> Claimant grants a contractual lien to Perry Chiropractic and Therapy Center with respect to my charges. Compliance herewith is requisite with notice by facsimile, letter, or telephone contact. 
                       ...
                       <tr class="row1">
				                  <td valign="middle" align="left" class="input_txt"><span class="err" id="nameerr">* </span>PatientName: </td>
				                  <td valign="top" align="left" class="input_txt">
				                  ...
				                  <td valign="top" align="left" class="input_txt">
				                  	...
				                  	<td valign="top" align="left" class="input_txt" width="20%"><span class="err">* </span>Date:  </td>
				                  <td valign="top" align="left" class="input_txt">
				                  ...
				                  <td valign="top" align="left" class="input_txt">
				                  	...
				                  	<tr class="row1">
				                  <td valign="top" align="left" class="input_txt" id="parentsign" width="23%"><span id="parentsignerror" style="color: red;font-style:italic;">* </span>Parent/Guardian Signature:  </td>
				                  <td valign="top" align="left" class="input_txt">
				                  	...
				                  	<td valign="top" align="left" class="input_txt"><span id="parentdateerr" class="err">* </span>Date:  </td>
				                  <td valign="top" align="left" class="input_txt">
				                  	<input type="text" class="input_txtbx1" id="datepicker3" name="parentdate" value="${assignment.parentdate}"/><br><span id="pdatepickererr" class="err"><form:errors path="Assignment.parentdate"></form:errors>
				                  	</tr> 
				                  	
				                  	<tr class="row1">
				                  <td valign="top" align="left" class="input_txt"><span class="err">* </span>Perry Chiropractic and Therapy Center Representative:  </td>
				                  <td valign="top" align="left" class="input_txt">
				                  	<input type="text" class="input_txtbx1" id="representative" name="representative" value="${assignment.representative}"/><span style="color: red;font-style:italic;" id="representativeerr" class="err"></span><form:errors path="Assignment.representative"></form:errors>
				                  	<td valign="top" align="left" class="input_txt"><span id="representativeerr" class="err">* </span>Date:  </td>
				                  <td valign="top" align="left" class="input_txt">
				                  	<input type="text" class="input_txtbx1" id="datepicker4" name="representativedate" value="${assignment.representativedate}"/><br><span id="representativedateerr" style="color:red;font-style:italic;"> </span><form:errors path="Assignment.representativedate"></form:errors>
				                  	</tr>
				                  	</table>
				                  	</c:otherwise>
				                  	</c:choose>
