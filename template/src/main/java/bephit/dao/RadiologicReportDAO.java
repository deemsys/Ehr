	 		...
	 		try{
	 			...
	 			while(resultSet.next()){
	 				radiologicReport.add(new RadiologicReport(resultSet.getString("pname"),resultSet.getString("date"),resultSet.getString("id"),resultSet.getString("dob"),
	 						resultSet.getString("views1"),resultSet.getString("negative_1"),resultSet.getString("positive_1"),resultSet.getString("positive_text1"),resultSet.getString("break_1"),resultSet.getString("break_text1"),resultSet.getString("adi_1"),resultSet.getString("hypolordosis_1"),resultSet.getString("normalcurvature_1"),resultSet.getString("hyperlordosis_1"),resultSet.getString("hyperlordosis_select1"),
