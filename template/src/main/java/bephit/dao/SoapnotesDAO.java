...
public class SoapnotesDAO {
	...
	public int setSoapnotes(SoapNotes soapnotes)
	{
	    ...
	    try{
	         ...
	         String cmd="INSERT INTO `tbl_soapnotes`(`pname`,`headache`,`neckpain`,`rightshoulderpain`,`leftshoulderpain`,`chestpain`,`rightarmpain`,`leftarmpain`,`rightelbowpain`,`leftelbowpain`,`rightwristpain`,`leftwristpain`,`righthandpain`,`lefthandpain`,`mbp`,`rightribpain`,`leftribpain`,`lbp`,`rightsipain`,`leftsipain`,`righthippain`,`lefthippain`,`rightgluteulpain`,`leftgluteulpain`,`rightlegpain`,`leftlegpain`,`rightkneepain`,`leftkneepain`,`rightanklepain`,`leftanklepain`,`rightfootpain`,`leftfootpain`,`diagnosis1`,`diagnosis2`,`diagnosis3`,`diagnosis4`,`e1e2`,`offwork1`,`reeval1`,`improved1`,`worsened1`,`fixation1`,`notimproved1`,`scsm1`,`improved2`,`worsened2`,`fixation2`,`notimproved2`,`scsm2`,`improved3`,`worsened3`,`fixation3`,`notimproved3`,`scsm3`,`improved4`,`worsened4`,`fixation4`,`notimproved4`,`improved5`,`worsened5`,`fixation5`,`notimproved5`,`scsm5`,`improved6`,`worsened6`,`fixation6`,`notimproved6`,`scsm6`,`improved7`,`worsened7`,`fixation7`,`notimproved7`,`scsm7`,`improved8`,`worsened8`,`fixation8`,`notimproved8`,`scsm8`)VALUES ('"+soapnotes.getPname()+"','"+soapnotes.getHeadache()+"','"+soapnotes.getNeckpain()+"','"+soapnotes.getRightshoulderpain()+"','"+soapnotes.getLeftshoulderpain()+"','"+soapnotes.getChestpain()+"','"+soapnotes.getRightarmpain()+"','"+soapnotes.getLeftarmpain()+"','"+soapnotes.getRightelbowpain()+"','"+soapnotes.getLeftelbowpain()+"','"+soapnotes.getRightwristpain()+"','"+soapnotes.getLeftwristpain()+"','"+soapnotes.getRighthandpain()+"','"+soapnotes.getLefthandpain()+"','"+soapnotes.getMbp()+"','"+soapnotes.getRightribpain()+"','"+soapnotes.getLeftribpain()+"','"+soapnotes.getLbp()+"','"+soapnotes.getRightsipain()+"','"+soapnotes.getLeftsipain()+"','"+soapnotes.getRighthippain()+"','"+soapnotes.getLefthippain()+"','"+soapnotes.getRightgluteulpain()+"','"+soapnotes.getLeftgluteulpain()+"','"+soapnotes.getRightlegpain()+"','"+soapnotes.getLeftlegpain()+"','"+soapnotes.getRightkneepain()+"','"+soapnotes.getLeftkneepain()+"','"+soapnotes.getRightanklepain()+"','"+soapnotes.getRightfootpain()+"','"+soapnotes.getLeftfootpain()+"','"+soapnotes.getDiagnosis1()+"','"+soapnotes.getDiagnosis2()+"','"+soapnotes.getDiagnosis3()+"','"+soapnotes.getDiagnosis4()+"','"+soapnotes.getE1e2()+"','"+soapnotes.getOffwork1()+"','"+soapnotes.getReeval1()+"','"+soapnotes.getImproved1()+"','"+soapnotes.getWorsened1()+"','"+soapnotes.getFixation1()+"','"+soapnotes.getNotimproved1()+"','"+soapnotes.getImproved2()+"','"+soapnotes.getWorsened2()+"','"+soapnotes.getFixation2()+"','"+soapnotes.getNotimproved2()+"','"+soapnotes.getScsm2()+"','"+soapnotes.getImproved3()+"','"+soapnotes.getWorsened3()+"','"+soapnotes.getFixation3()+"','"+soapnotes.getNotimproved3()+"','"+soapnotes.getScsm3()+"','"+soapnotes.getImproved4()+"','"+soapnotes.getWorsened4()+"','"+soapnotes.getFixation4()+"','"+soapnotes.getNotimproved4()+"','"+soapnotes.getScsm4()+"','"+soapnotes.getImproved5()+"','"+soapnotes.getWorsened5()+"','"+soapnotes.getFixation5()+"','"+soapnotes.getNotimproved5()+"','"+soapnotes.getScsm5()+"','"+soapnotes.getImproved6()+"','"+soapnotes.getWorsened6()+"','"+soapnotes.getFixation6()+"','"+soapnotes.getNotimproved6()+"','"+soapnotes.getScsm6()+"','"+soapnotes.getImproved7()+"','"+soapnotes.getWorsened7()+"','"+soapnotes.getFixation7()+"','"+soapnotes.getNotimproved7()+"','"+soapnotes.getScsm7()+"','"+soapnotes.getImproved8()+"','"+soapnotes.getWorsened8()+"','"+soapnotes.getFixation8()+"','"+soapnotes.getNotimproved8()+"','"+soapnotes.getScsm8()+"')";
