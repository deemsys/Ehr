...
<div id="right_content">
        ...
        <td valign="top" align="left" style="padding:5px 0 10px 0;">&nbsp;
            ...
            <p class="closestatus"><a title="Close" href="viewxray">x</a></p>
				     ...
				     <tr class="title">
						...
						<c:if test="${fn:length(xrayform.xraydetails) gt 0}">
        				 <c:forEach items="${xrayform.xraydetails}" var="xraydetails" varStatus="status">
											...
											<a href="#" title="" ><img src="resources/images/icons/icon_edit.png" alt="Edit" /></a> <a href="<c:out value="editxray?xrayid=${xraydetails.xrayid}"/>"  style="padding-right:10px; ">Edit</a>
											<a href="#" title=""><img src="resources/images/icons/icon_delete.png" alt="Delete" /></a><a href=" <c:out value="deletexray?xrayid=${xraydetails.xrayid}"/>" onclick="return confirmation() ">Remove</a>
											</td>
										
								</tr>
							    	</c:forEach>
							    </c:if>	
							    <c:if test="${fn:length(xrayform.xraydetails) == 0}">	
							    	<tr class="row1">
