 ...
 <div>
         ...
         <c:set value="${shoulderexamform.shoulderexamdetails[0]}" var="shoulderexamdetails"/>
          <table cellpadding="0" cellspacing="0" border="0" >
           ...
           <td width="200"><input type="hidden" value="${shoulderexamdetails.shoulderexamno}" name="shoulderexamno"><input type="text" value="${shoulderexamdetails.pname}" name="pname" id="pname"><br><span class="err" id="pnameerror"><form:errors path="shoulderexamdetails.pname"></form:errors></td><td width="630"></td>
...
<td><textarea rows="5" cols="50" name="note" >${shoulderexamdetails.note}</textarea></td>	
	...
	<table  style="border:10">      
         ...
         <tr height="10"></tr>
         <tr><td>Flexion:</td><td>180</td><td><input type="text" size="5" value="${shoulderexamdetails.flexionleft}" name="flexionleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.flexionright}" name="flexionright" onkeypress="return isNumberKey(event);"></td><td width="210"></td><td>Empty Can:</td><td width="200"></td><td><input size="5" type="text" value="${shoulderexamdetails.emptycanleft}" name="emptycanleft">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="5" value="${shoulderexamdetails.emptycanright}" name="emptycanright"></td></tr>
         <tr><td>Extension:</td><td>50</td><td><input size="5" type="text" value="${shoulderexamdetails.extensionright}" name="extensionleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text"  value="${shoulderexamdetails.extensionleft}" name="extensionright" onkeypress="return isNumberKey(event);"></td><td width="90"></td><td>Impingement Sign:</td><td width="150"></td><td><input type="text"  size="5" value="${shoulderexamdetails.impingementsignleft}" name="impingementsignleft">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="5" value="${shoulderexamdetails.impingementsignright}" name="impingementsignright"></td></tr>
         <tr><td>Abduction:</td><td>180</td><td><input size="5" type="text" value="${shoulderexamdetails.abductionleft}" name="abductionleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input  size="5" type="text" value="${shoulderexamdetails.abductionright}" name="abductionright" onkeypress="return isNumberKey(event);"></td><td width="90"></td><td>Apley's Scratch:</td><td width="150"></td><td><input type="text" size="5"  value="${shoulderexamdetails.apleysscratchleft}" name="apleysscratchleft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.apleysscratchright}" name="apleysscratchright"></td></tr>
         <tr><td>Adduction:</td><td>50</td><td><input size="5" type="text" value="${shoulderexamdetails.adductionleft}" name="adductionleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.adductionright}" name="adductionright" onkeypress="return isNumberKey(event);"></td><td width="90"></td><td>Subacrominal Push:</td><td width="150"></td><td><input type="text" size="5" value="${shoulderexamdetails.subacrominalpushleft}"  name="subacrominalpushleft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.subacrominalpushright}"   name="subacrominalpushright"></td></tr></tr>
         <tr><td>Internal Rotation:</td><td>90</td><td><input type="text" size="5"  value="${shoulderexamdetails.internalrotationleft}" name="internalrotationleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text"  value="${shoulderexamdetails.internalrotationright}" name="internalrotationright" onkeypress="return isNumberKey(event);"><td width="90"></td><td>Dawbarn's:</td><td width="150"></td><td><input type="text" size="5" value="${shoulderexamdetails.dawbarnsleft}"  name="dawbarnsleft">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="5"  value="${shoulderexamdetails.dawbarnsright}" name="dawbarnsright"></td></td></tr>
         <tr><td>External Rotation:	</td><td>90</td><td><input type="text" size="5"  value="${shoulderexamdetails.externalrotationleft}" name="externalrotationleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" name="externalrotationright" value="${shoulderexamdetails.externalrotationright}" onkeypress="return isNumberKey(event);"></td><td width="90"></td><td>Yergason's:</td><td width="150"></td><td><input type="text" size="5" value="${shoulderexamdetails.yergasonsleft}" name="yergasonsleft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.yergasonsright}" name="yergasonsright"></td></tr>
        ...
        <tr>
         ...
         <td width="246"><input type="checkbox"   <c:if test="${shoulderexamdetails.neurological=='Neurological Testing Unremarkable'}"> <c:out value="checked=checked"></c:out></c:if> id=neurologicalunremarkable name="neurological" value="Neurological Testing Unremarkable">Neurological Testing Unremarkable</td>
          ...
          <tr height="10"></tr>
           ...
           <tr><td>C5</td><td><input size="5" type="text"  value="${shoulderexamdetails.latdeltoidleft}" name="latdeltoidleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.latdeltoidright}" name="latdeltoidright" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;(Lat deltoid)</td><td>C5</td><td><input type="text" name="shdleft" value="${shoulderexamdetails.shdleft}" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text"  value="${shoulderexamdetails.shdright}"name="shdright" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Shd ABD)</td><td>C5</td><td><input type="text" name="bicepsleft"  value="${shoulderexamdetails.bicepsleft}" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${shoulderexamdetails.bicepsright}" name="bicepsright" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Biceps)</td></tr>
           <tr><td>C6</td><td><input type="text" name="latarmleft" value="${shoulderexamdetails.latarmleft}" size="5" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.latarmright}" name="latarmright" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;(Lat arm/hand)</td><td>C6</td><td><input type="text" name="elbflexleft" value="${shoulderexamdetails.elbflexleft}" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text"  value="${shoulderexamdetails.elbflexright}" name="elbflexright" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Elb flex/wrist ext)</td><td>C6</td><td><input type="text" name="brachioradleft" value="${shoulderexamdetails.brachioradleft}"  size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"  value="${shoulderexamdetails.brachioradright}" name="brachioradright"  size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Brachiorad)</td></tr>
           <tr><td>C7</td><td><input type="text" size="5" value="${shoulderexamdetails.thirdleft}" name="thirdleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input  size="5"type="text"  value="${shoulderexamdetails.thirdright}" name="thirdright" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;(3rd digit)</td><td>C7</td><td><input type="text" value="${shoulderexamdetails.elbextleft}"  name="elbextleft" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.elbextright}" name="elbextright" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Elb ext/wrist flex)</td><td>C7</td><td><input type="text" value="${shoulderexamdetails.tricepsleft}" name="tricepsleft" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.tricepsright}" name="tricepsright" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Triceps)</td></tr>
            <tr><td>C8</td><td><input type="text" size="5" value="${shoulderexamdetails.medforearmleft}" name="medforearmleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="5"  value="${shoulderexamdetails.medforearmright}" name="medforearmright" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;(Med forearm/hand)</td><td>C8</td><td><input type="text" name="digitflexionleft"  value="${shoulderexamdetails.digitflexionleft}" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5"   value="${shoulderexamdetails.digitflexionright}" type="text" name="digitflexionright" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Digit flexion)</td><td></td></tr>
            <tr><td>T1</td><td><input size="5" type="text" value="${shoulderexamdetails.medelbowleft}"  name="medelbowleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text"  value="${shoulderexamdetails.medelbowright}" name="medelbowright" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;(Med elbow/arm)</td><td>T1</td><td><input type="text" name="digitabdleft" value="${shoulderexamdetails.digitabdleft}"  size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input  size="5"type="text"value="${shoulderexamdetails.digitabdright}" name="digitabdright" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Digit abd/add)	</td><td><td>&nbsp;(2+/5 is Normal)</td></td></tr>
           ...
           <div><B style="font-size:14px"><span class="err">*</span>PHYSICIAN SIGNATURE:</B>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${shoulderexamdetails.signature}" name="signature" id="sign"><span class="err" id="signerror"><form:errors path="shoulderexamdetails.signature"></form:errors></div>
           
         
         <table align="right"><tr><td><input type="submit" value="Save" class="submit_btn" onclick="return checkSubmit('this');"></td><td> <a href="viewshoulderexamdetails" style="color: white" class="submit_btn" onclick="myclose()">Cancel</a></td></tr></table>
         <script>
 function myclose()
 {
	 window.close();
