...
<div id="right_content">
        ...
        <td valign="top" align="left" style="padding:5px 0 10px 0;">&nbsp;
            ...
            <p class="closestatus"><a title="Close" href="viewallpatientdetails">x</a></p>
        				       	...
        				       	<tr class="row1">
							      	 <td valign="top" align="left"  width="10%"> <a href="patientDetailsList?patient_id=${patientDetails.patient_id}">${patientDetails.name}</a></td>
											...
											<td valign="top" align="left" width="10%">${patientDetails.state}</td>
											 <td>
												<a href="#" title="" ><img src="resources/images/icons/icon_edit.png" alt="Edit" /></a><a href="<c:out value="editadminpatientdetails?patient_id=${patientDetails.patient_id}"/>" style="padding-right:10px;">Edit</a>
												<a  href="#" title=""><img src="resources/images/icons/icon_delete.png" alt="Delete" /></a><a href="<c:out value="deleteadminpatientdetails?patient_id=${patientDetails.patient_id}" />" onclick="return confirmation()">Remove</a>
											</td> 
	...
	<div class="extrabottom">
             ...
             <li class="page_unselect"><a href="viewadminpatient_page?page=${currentpage - 1}" >Prev</a></li> 
               </c:if>
