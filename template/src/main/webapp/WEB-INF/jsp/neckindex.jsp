...
<td valign="top" align="left">
 <div id="block1">
        ...
        <table> <tr><td width="140"><span class="err">* </span>Name</td>
           <td><input type="text" id="pname" name="name" onInput="return validatename(id)";><Br><span style="color: red;font-style:italic;" id="pnameerror"><form:errors path="neckindex.name"></form:errors></td><td width="480"></td><td></td>
           <td >&nbsp;&nbsp;&nbsp;&nbsp;<span class="err">* </span>Date:&nbsp;</td> <td><input type="text" name="date" id="datepicker"><Br><span style="color: red;font-style:italic;" id="datepickererror"><form:errors path="neckindex.date"></form:errors></td>
           </tr></table>
