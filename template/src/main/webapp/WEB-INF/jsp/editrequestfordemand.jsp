...
<div>
 ...
 <table cellpadding="0" cellspacing="0" border="0" width="50%" class="margin_table" style="width: 683px; "><tr><td>
    ...
    <p> Check every box that applies:</p> <br>
     ...
     <tr><td style="width: 683px; "><input type="checkbox" class="input_ckbx1" name="date" id="date">&nbsp;&nbsp;&nbsp;&nbsp;The At-Fault Insurer has already paid the attorney and/or patient full settlement and has failed to comply with the Assignment.<br><br>
    </td></tr>
     
     <tr><td style="width: 683px; "><input type="checkbox" class="input_ckbx1" name="date" id="date">&nbsp;&nbsp;&nbsp;&nbsp;	The At-Fault Insurer or The Med Pay Insurer has stated orally or in writing to us that it will not comply with the Assignment.
<br><br>

     </td></tr>
     
     <tr><td style="width: 683px; "> <input type="checkbox" class="input_ckbx1" name="date" id="date">&nbsp;&nbsp;&nbsp;&nbsp;The Med Pay Insurer has already paid benefits to the patient and/or the attorney. <br><br> </td></tr>
     
     <tr><td style="width: 683px; "><input type="checkbox" class="input_ckbx1" name="date" id="date">&nbsp;&nbsp;&nbsp;&nbsp;	Our patient filed bankruptcy.  In addition to the document below, we are faxing every letter or document, which references the bankruptcy filing.<br>
    <br> </td></tr>
     
     <tr><td style="width: 683px; "><input type="checkbox" class="input_ckbx1" name="date" id="date">&nbsp;&nbsp;&nbsp;&nbsp;	If treatment is completed in addition to the document below we attach a copy of our itemized charges and a copy of the patient intake information form.<br><br>
     </td></tr>
     
     <tr><td style="width: 683px; "><input type="checkbox" class="input_ckbx1" name="date" id="date">&nbsp;&nbsp;&nbsp;&nbsp;Other: (Describe)<input type="hidden" name="requestid" value="${requestfordemanddetails.requestid }"><input type="text" class="input_txtbx1" value="${requestfordemanddetails.other1}" name="other1" id="other1" style="width: 483px; "><span class="err"><form:errors path="Requestfordemand.other1"></form:errors></span><br><br>
     </td></tr>
      <tr><td style="width: 683px; "><input type="text" class="input_txtbx1" value="${requestfordemanddetails.other2}"  name="other2" id="other2" style="width: 593px; "><span class="err"><form:errors path="Requestfordemand.other2"></form:errors></span><br><br>
     </td></tr>
      <tr><td style="width: 683px; "><input type="text" class="input_txtbx1" name="other3" value="${requestfordemanddetails.other3}"  id="other3" style="width: 593px; "><span class="err"><form:errors path="Requestfordemand.other3"></form:errors></span><br><br>
     </td></tr>
      <tr><td style="width: 683px; "><input type="text" class="input_txtbx1" value="${requestfordemanddetails.other4}"  name="other4" id="other4" style="width: 593px; "><span class="err"><form:errors path="Requestfordemand.other4"></form:errors></span><br><br>
     </td></tr>
     
         
     <tr><td style="width: 683px; "><input type="checkbox" class="input_ckbx1" name="date" id="date">&nbsp;&nbsp;&nbsp;&nbsp;	Please send the appropriate Demand Letter and copy to us.  The cost will be $181.50 plus postage and copy charges at .10/page.<br>
     </td></tr>
