...
public class RadiologicReport{
	...
	public RadiologicReport(String pname, String date, String id, String dob,
			...
			String break_1, String adi_1, String hypolorodosis_1,
			String normalcurvature_1, String hyperlordosis_1,
			String hyperlordosis_select1, String mcGregorslinenormal_1,
			String mcGregorslineinterupted_1,
			...
			String anterior_1, String subchondral_1, String subchondral_text1,
			String schmorls_1, String schmorls_text1, String foraminal_1,
			...
			String apexat_text1,String softtissueedemaof_1, String softtissueedemaof_text1,
			String other_1, String other_text1, String views2,
			String negative_2, String hyperkyphosis_2, String normalkyphosis_2,
			String hypokyphosis_2, String degenerative_2,
