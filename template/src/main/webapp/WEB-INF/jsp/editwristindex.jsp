	...
	<c:set value="${wristindexform.wristindexdetails[0]}" var="wristindexdetails"></c:set>
	     ...
	     <div class="contentbox">
          <table cellpadding="0" cellspacing="0" border="0" >
           ...
           <td><input type="hidden" name="wristindexno" class="input_txt" value="${wristindexdetails.wristindexno}"><input type="text" name="name" class="input_txt" value="${wristindexdetails.name}"><br><span class="err"><form:errors path="wristindexdetails.name"></form:errors></td><td width="480"></td><td></td><td width="100"></td>
           <td >&nbsp;&nbsp;&nbsp;&nbsp;<span class="err">*</span>Date:&nbsp;</td> <td><input type="text" name="date" id="datepicker" value="${wristindexdetails.date}"><br><span class="err"><form:errors path="wristindexdetails.date"></form:errors></td>
           </tr>
...
<tr><td><input type="radio" name="painintensity"  onclick="doAjaxPost()" class="painintensity" id="painintensity" <c:if test="${wristindexdetails.painintensity=='2'}"> <c:out value="checked"></c:out></c:if> value="2">&nbsp;&nbsp;The pain in my wrist/hand is mild but constant</td>
 ...
 <div id="slider"></div></td><td>Worst possible pain</td></tr></table>
          ...
          <td><input type="button" value="Calculate" onclick="return percentage()" class="submit_btn"> </td>
           ...
           <table align="right"><tr><td><input type="submit" value="Update" class="submit_btn"></td><td> <a href="viewwristindex" style="color: white" class="submit_btn">Cancel</a></td></tr></table>
