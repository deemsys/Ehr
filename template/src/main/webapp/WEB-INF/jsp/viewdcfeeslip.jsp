...
<div id="right_content">
 ...
 --%>												<%--<c:if test="${currentuser.adminuser[0].deleteparticipant==1}"> --%>
	...
	<div class="extrabottom">
             ...
             <li class="page_unselect"><a href="viewdcfeeslip_page?page=${currentpage - 1}" >Prev</a></li> 
               </c:if>
             ...
             <%-- <c:forEach var="count" begin="1" end="${noofrows}">  --%>
               <c:forEach begin="1" end="${noofpages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page_unselect"><a href="viewdcfeeslip_page?page=${i}"><c:out value="${i}"></c:out></a></li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>          
            <c:if test="${currentpage!=noofpages}">
              <li class="page_unselect"><a href="viewdcfeeslip_page?page=${currentpage+1}">Next</a></li> 
                 </c:if>
              <c:choose>
              <c:when test="${button=='viewall'}">
                  <li class="page"><a href="viewalldcfeeslip" class="paging_select">ViewAll</a></li>
             </c:when>
                <c:otherwise>
                  <li class="page"><a href="viewdcfeeslip" class="paging_select">Back</a></li>
              </c:otherwise>
              </c:choose>
              </ul>
              </div>
