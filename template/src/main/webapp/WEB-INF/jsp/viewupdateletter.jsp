...
<div id="right_content">
        ...
        <td valign="top" align="left" style="padding:5px 0 10px 0;">&nbsp;
            ...
            <p class="closestatus"><a title="Close" href="viewupdateletter">x</a></p>
			      ...
			      <form action="physicalexam" method="POST"> 
				     ...
				     <tr class="title">
								...
								<td valign="top" align="left" width="10%">ID</td>
         						<td valign="top" align="left" width="10%"> Attorney  Name</td>					         	
					         	<td valign="top" align="left" width="10%">Date of injury</td>
						...
						<c:if test="${fn:length(updateletterform.updateletterdetails) gt 0}">
        				 <c:forEach items="${updateletterform.updateletterdetails}" var="updateletterdetails" varStatus="status">
											...
											<a href="#" title="" ><img src="resources/images/icons/icon_edit.png" alt="Edit" /></a> <a href="<c:out value="editupdateletter?updateid=${updateletterdetails.updateid}"/>"  style="padding-right:10px; ">Edit</a>
											<a href="#" title=""><img src="resources/images/icons/icon_delete.png" alt="Delete" /></a><a href=" <c:out value="deleteupdateletter?updateid=${updateletterdetails.updateid}"/>" onclick="return confirmation() ">Remove</a>
											</td>
										
								</tr>
							    	</c:forEach>
							    </c:if>	
							    <c:if test="${fn:length(updateletterform.updateletterdetails) == 0}">	
							    	<tr class="row1">
