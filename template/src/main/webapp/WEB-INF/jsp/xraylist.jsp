...
<table cellpadding="0" cellspacing="0" border="0" width="60%" class="margin_table">
 ...
 <table cellpadding="0" cellspacing="0" border="0" width="100%">
 <tr><td>
 I<input type="hidden" name="xrayid" value="${xraydetails.xrayid }"> <c:out value="${xraydetails.name}"/>  do hereby agree to return X-rays that I have borrowed from the Chiropractic Therapy Center, I understand that I have fourteen (14) days to do so.I fully agree that in the event that I do not return X-rays, I will be billed $50.00.  	  
       </td></tr></table><br><br>
 
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="100"><span class="err">*</span>Date Borrowed</td>
              <td ><c:out value="${xraydetails.date}"/> </td>
              </tr>
              </table>
               <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="100"><span class="err">*</span>Date Due</td>
              <td ><c:out value="${xraydetails.date1}"/> </td>
              </tr>
              </table><br><br>
             <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="100"><span class="err">*</span>Date </td>
              <td width="70"><c:out value="${xraydetails.date2}"/> </td>
              <td align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Signature:</td>
             <td width="50"><c:out value="${xraydetails.sign}"/> </td>
