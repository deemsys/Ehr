        ...
        <tr>
         ...
         <td width="246"><input type="checkbox"   <c:if test="${shoulderexamdetails.neurological=='Neurological Testing Unremarkable'}"> <c:out value="checked=checked"></c:out></c:if> id=neurologicalunremarkable name="neurological" value="Neurological Testing Unremarkable">Neurological Testing Unremarkable</td>
          ...
          <tr height="10"></tr>
           ...
           <tr><td>C5</td><td><input size="5" type="text"  value="${shoulderexamdetails.latdeltoidleft}" name="latdeltoidleft" onkeypress="return validate(event)">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.latdeltoidright}" name="latdeltoidright" onkeypress="return validate(event)">&nbsp;&nbsp;(Lat deltoid)</td><td>C5</td><td><input type="text" name="shdleft" id="shdleft" value="${shoulderexamdetails.shdleft}" size="5" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text"  value="${shoulderexamdetails.shdright}"name="shdright" id="shdright" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;(Shd ABD)</td><td>C5</td><td><input type="text" name="bicepsleft" id="bicepsleft" value="${shoulderexamdetails.bicepsleft}" size="5" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${shoulderexamdetails.bicepsright}" name="bicepsright" id="bicepsright" size="5" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;(Biceps)</td></tr>
           <tr><td>C6</td><td><input type="text" name="latarmleft" value="${shoulderexamdetails.latarmleft}" size="5" onkeypress="return validate(event)">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.latarmright}" name="latarmright" onkeypress="return validate(event)">&nbsp;&nbsp;(Lat arm/hand)</td><td>C6</td><td><input type="text" name="elbflexleft" id="elbflexleft" value="${shoulderexamdetails.elbflexleft}" size="5" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text"  value="${shoulderexamdetails.elbflexright}" name="elbflexright" id="elbflexright" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;(Elb flex/wrist ext)</td><td>C6</td><td><input type="text" name="brachioradleft" id="brachioradleft" value="${shoulderexamdetails.brachioradleft}"  size="5" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"  value="${shoulderexamdetails.brachioradright}" name="brachioradright" id="brachioradright" size="5" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;(Brachiorad)</td></tr>
           <tr><td>C7</td><td><input type="text" size="5" value="${shoulderexamdetails.thirdleft}" name="thirdleft" onkeypress="return validate(event)">&nbsp;&nbsp;&nbsp;&nbsp;<input  size="5"type="text"  value="${shoulderexamdetails.thirdright}" name="thirdright" onkeypress="return validate(event)">&nbsp;&nbsp;(3rd digit)</td><td>C7</td><td><input type="text" value="${shoulderexamdetails.elbextleft}"  name="elbextleft" id="elbextleft" size="5" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.elbextright}" name="elbextright" id="elbextright" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;(Elb ext/wrist flex)</td><td>C7</td><td><input type="text" value="${shoulderexamdetails.tricepsleft}" name="tricepsleft" id="tricepsleft" size="5" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${shoulderexamdetails.tricepsright}" name="tricepsright" id="tricepsright"  onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;(Triceps)</td></tr>
            <tr><td>C8</td><td><input type="text" size="5" value="${shoulderexamdetails.medforearmleft}" name="medforearmleft" onkeypress="return validate(event)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Med fo<input type="text" size="5" value="${shoulderexamdetails.medforearmright}" name="medforearmright" onkeypress="return validate(event)">rearm/hand)</td><td>C8</td><td><input type="text" name="digitflexionleft"  id="digitflexionleft" value="${shoulderexamdetails.digitflexionleft}" size="5" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5"   value="${shoulderexamdetails.digitflexionright}" type="text" name="digitflexionright" id="digitflexionright" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;(Digit flexion)</td><td></td></tr>
            <tr><td>T1</td><td><input size="5" type="text" value="${shoulderexamdetails.medelbowleft}"  name="medelbowleft" onkeypress="return validate(event)">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text"  value="${shoulderexamdetails.medelbowright}" name="medelbowright" onkeypress="return validate(event)">&nbsp;&nbsp;(Med elbow/arm)</td><td>T1</td><td><input type="text" name="digitabdleft" id="digitabdleft" value="${shoulderexamdetails.digitabdleft}"  size="5" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;&nbsp;&nbsp;<input  size="5"type="text"value="${shoulderexamdetails.digitabdright}" name="digitabdright" id="digitabdright" onKeyPress="return check(id,event,value)" onInput="checkLength(id)">/5&nbsp;&nbsp;(Digit abd/add)	</td><td><td>&nbsp;(2+/5 is Normal)</td></td></tr>
         ...
         <table align="right"><tr><td><input type="submit" value="update" class="submit_btn" onclick="return checkSubmit('this');"></td><td> <a href="viewshoulderexamdetails" style="color: white" class="submit_btn" onclick="myclose()">Cancel</a></td></tr></table>
         <script>
 function myclose()
 {
	 window.close();
