...
<c:when test="${empty medpay}">
 ...
 <table cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <td><textarea rows="" cols="" name="address"  class=input_txtarea" id="address"style="width: 162px; height: 62px"></textarea><span class="err"><form:errors path="Pimedpay.address"></form:errors></span></td>
              </tr>
              </table>
              <br>
               <table cellpadding="0" cellspacing="0" border="0" width="100%">
