...
public class Workschool
{
	...
	public Workschool(String workid, String username, String date,
			String letter, String beexcused, String excused, String beconfined,
			...
			String regular, String returndate, String diagnosis) {
		super();
		this.workid = workid;
		this.username = username;
		this.date = date;
