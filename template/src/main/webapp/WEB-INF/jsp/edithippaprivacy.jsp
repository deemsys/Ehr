...
function validatesign()
{
  ...
  <script>
    ...
    if(document.getElementById("legalguardian").value.length<4 || document.getElementById("printpname").value.length>=32)
    {
 	...
 	if(document.getElementById("legalguardian").value.substring(0,1)==" ")
	{
	document.getElementById("legalguardianerror").innerHTML="Initial space not allowed";
...
<form action="updatehippaprivacy" method="POST">
 ...
 <tr>
      ...
      <td valign="top" align="left">
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
  				<c:set value="${HippaPrivacyForm.privacyDetails[0]}" var="privacydetails"> </c:set>
  				...
  				<tr>
    				<td align="left" valign="top" width="100%" style="padding-right:25px;">
                       ...
                       <p id="mypar">You may revoke this authorization, at any time, in writing, except to the extent that your physician or the physician’s practice has taken an action in reliance on the use or disclosure indicated in the authorization.</p>
                        ...
                        <tr class="row1">
                        <td valign="middle" align="left" class="input_txt"><span class="err">* </span>Print Patient name: </td>
              ...
              <td>&nbsp;&nbsp;</td>
              <td><a href="deletehippaprivacy?hippa_no=${privacydetails.hippa_no}" class="submit_btn" style="text-decoration: none;color:white" onclick="return confirmation() ">Delete</a></td>
        	  </tr>
        	  </table>
                        </td>
                        </tr>
