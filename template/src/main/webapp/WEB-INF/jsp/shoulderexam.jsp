...
<td valign="top" align="left">
 <div>
      ...
      <table align="right"><tr><td><input type="submit" value="Save" id="saveid" class="submit_btn" onclick="return checkSubmit('this');"></td><td> <a href="viewshoulderexamdetails" style="color: white" class="submit_btn" onclick="myclose()" id="cancelid">Cancel</a></td></tr></table>
