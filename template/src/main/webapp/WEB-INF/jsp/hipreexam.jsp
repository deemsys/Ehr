...
<table id="softtissue" >	
	...
	<table  style="border:10">      
         ...
         <tr height="10"></tr>
         <tr><td>Flexion:		</td><td>100</td><td><input type="text" size="5" value="${hipexamdetails.flexionleft}"name="flexionleft" onkeypress="return validate(event)">&nbsp;&nbsp;&nbsp;&nbsp;<input value="${hipexamdetails.flexionright}"  onkeypress="return validate(event)" size="5" type="text" name="flexionright"></td><td width="90"></td><td>Patrick Fabere:	</td><td width="150"></td><td><input size="5" type="text"  name="fabereleft" onkeypress="return validate(event)" value="${hipexamdetails.fabereleft}">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${hipexamdetails.fabereleft}"  onkeypress="return validate(event)" size="5" name="fabereright"></td></tr>
         <tr><td>Extension:			</td><td>30</td><td><input size="5" type="text" onkeypress="return validate(event)" value="${hipexamdetails.extensionleft}" name="extensionleft">&nbsp;&nbsp;&nbsp;&nbsp;<input value="${hipexamdetails.extensionright}" size="5" type="text" name="extensionright" onkeypress="return validate(event)"></td><td width="90"></td><td>Nachlas:</td><td width="150"></td><td><input type="text"  size="5" name="nachlasleft" value="${hipexamdetails.nachlasleft}" onkeypress="return validate(event)">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${hipexamdetails.nachlasright}" size="5" onkeypress="return validate(event)"  name="nachlasright"></td></tr>
         <tr><td>Abduction:				</td><td>45</td><td><input size="5" type="text" onkeypress="return validate(event)" name="abductionleft" value="${hipexamdetails.abductionright}">&nbsp;&nbsp;&nbsp;&nbsp;<input value="${hipexamdetails.abductionleft}"  size="5" type="text" name="abductionright" onkeypress="return validate(event)"></td><td width="90"></td><td>Ely's:</td><td width="150"></td><td><input type="text" size="5"  onkeypress="return validate(event)"  name="elysleft" value="${hipexamdetails.elysleft}">&nbsp;&nbsp;&nbsp;&nbsp;<input value="${hipexamdetails.elysright}" onkeypress="return validate(event)" size="5" type="text"  name="elysright"></td></tr>
         <tr><td>Adduction:				</td><td>30</td><td><input size="5" type="text" onkeypress="return validate(event)" value="${hipexamdetails.adductionleft}" name="adductionleft">&nbsp;&nbsp;&nbsp;&nbsp;<input value="${hipexamdetails.adductionright}" onkeypress="return validate(event)" size="5" type="text" name="adductionright"></td><td width="90"></td><td>Yeoman's:</td><td width="150"></td><td><input type="text" size="5" onkeypress="return validate(event)"  value="${hipexamdetails.yeomansleft}" name="yeomansleft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" onkeypress="return validate(event)" value="${hipexamdetails.yeomansright}" name="yeomansright"></td></tr></tr>
         <tr><td>Internal Rotation:</td><td>40</td><td><input type="text" size="5" onkeypress="return validate(event)" name="internalrotationleft" value="${hipexamdetails.internalrotationleft}">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" onkeypress="return validate(event)" value="${hipexamdetails.internalrotationright}" name="internalrotationright"><td width="90"></td><td>Ober's:	</td><td width="150"></td><td><input type="text" size="5" onkeypress="return validate(event)" value="${hipexamdetails.obersleft}" name="obersleft">&nbsp;&nbsp;&nbsp;&nbsp;<input  value="${hipexamdetails.obersright}" onkeypress="return validate(event)" type="text" size="5" name="obersright"></td></td></tr>
         <tr><td>External Rotation:</td><td>45</td><td><input type="text" size="5" onkeypress="return validate(event)" name="externalrotationleft" value="${hipexamdetails.externalrotationleft}">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" onkeypress="return validate(event)" value="${hipexamdetails.externalrotationright}" name="externalrotationright"></td><td width="90"></td><td>	Hibbs:</td><td width="150"></td><td><input type="text" size="5" onkeypress="return validate(event)"  value="${hipexamdetails.hibbsleft}" name="hibbsleft">&nbsp;&nbsp;&nbsp;&nbsp;<input  value="${hipexamdetails.hibbsright}"size="5" type="text" onkeypress="return validate(event)"  name="hibbsright"></td></tr>
          <tr><td></td><td></td><td>&nbsp;&nbsp;</td><td width="90"></td><td>Thomas:</td><td width="150"></td><td><input type="text" onkeypress="return validate(event)" size="5" value="${hipexamdetails.thomasleft}" name="thomasleft">&nbsp;&nbsp;&nbsp;&nbsp;<input value="${hipexamdetails.thomasright}" onkeypress="return validate(event)" type="text" size="5" name="thomasright"></td></tr>
         </table>
         </td></tr></table></div></div>
        <div id="tabs-2">     
 ...
 <div>
        ...
        <tr>
         ...
         <td width="246"><input type="checkbox"   <c:if test="${hipexamdetails.neurological=='Neurological Testing Unremarkable'}"> <c:out value="checked=checked"></c:out></c:if> id=neurologicalunremarkable name="neurological" value="Neurological Testing Unremarkable">Neurological Testing Unremarkable</td>
          ...
          <tr height="10"></tr>
           <tr><td>L1</td><td><input type="text" value="${hipexamdetails.inguinalarealeft}"  size="5" onkeypress="return validate(event)" name="inguinalarealeft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${hipexamdetails.inguinalarearight}" onkeypress="return validate(event)"  name="inguinalarearight">&nbsp;&nbsp; Inguinal area</td><td>L1</td><td><input size="5" type="text" onKeyPress="return check(id,event,value)" onInput="checkLength(id)" value="${hipexamdetails.iliopsoasfirstleft}"   name="iliopsoasfirstleft" id="iliopsoasfirstleft">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"   size="5" value="${hipexamdetails.iliopsoasfirstright}" name="iliopsoasfirstright"  id="iliopsoasfirstright" onKeyPress="return check(id,event,value)" onInput="checkLength(id)"
           >/5&nbsp;&nbsp; Iliopsoas</td><td></td><td></td></tr>
           <tr><td>L2</td><td><input size="5" type="text" value="${hipexamdetails.antleft}" onkeypress="return validate(event)" name="antleft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" value="${hipexamdetails.antright}" onkeypress="return validate(event)" type="text" name="antright">&nbsp;&nbsp;Ant/med thigh</td><td>L2</td><td><input type="text"  name="iliopsoas1left" id="iliopsoas1left" onKeyPress="return check(id,event,value)" onInput="checkLength(id)" value="${hipexamdetails.iliopsoas1left}"  size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" onKeyPress="return check(id,event,value)" onInput="checkLength(id)" value="${hipexamdetails.iliopsoas1right}"  type="text" id="iliopsoas1right" name="iliopsoas1right">/5&nbsp;&nbsp;Iliopsoas</td><td></td><td>&nbsp;(2+/5 is Normal)</td></tr>
           <tr><td>L3</td><td><input type="text" value="${hipexamdetails.kneeleft}" onkeypress="return validate(event)"   name="kneeleft" size="5">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" onkeypress="return validate(event)" value="${hipexamdetails.kneeright}"  name="kneeright">&nbsp;&nbsp;Medial knee</td><td>L3</td><td><input type="text" onKeyPress="return check(id,event,value)" onInput="checkLength(id)" name="iliopsoas2left" id="iliopsoas2left" value="${hipexamdetails.iliopsoas2left}"  size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" onKeyPress="return check(id,event,value)" onInput="checkLength(id)" value="${hipexamdetails.iliopsoas2right}"  name="iliopsoas2right" id="iliopsoas2right" >/5&nbsp;&nbsp;Iliopsoas</td><td></td><td>&nbsp; </td></tr>
           <tr><td>L4</td><td><input type="text" size="5" value="${hipexamdetails.medialleft}" onkeypress="return validate(event)"  name="medialleft">&nbsp;&nbsp;&nbsp;&nbsp;<input  size="5"type="text" onkeypress="return validate(event)"  value="${hipexamdetails.medialright}"  name="medialright">&nbsp;&nbsp;Medial leg</td><td>L4</td><td><input type="text"  onKeyPress="return check(id,event,value)" onInput="checkLength(id)" value="${hipexamdetails.femleft}"  name="femleft" id="femleft" size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" onKeyPress="return check(id,event,value)" onInput="checkLength(id)" value="${hipexamdetails.femright}" id="femright"  name="femright">/5&nbsp;&nbsp;Rectus Fem</td><td>L4</td><td><input type="text" value="${hipexamdetails.patellarleft}" onKeyPress="return check(id,event,value)" onInput="checkLength(id)" name="patellarleft" id="patellarleft" size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${hipexamdetails.patellarright}"   id="patellarright" onKeyPress="return check(id,event,value)" onInput="checkLength(id)" name="patellarright" size="5">/5&nbsp;&nbsp;Patellar</td></tr>
            <tr><td>L5</td><td><input type="text" size="5" value="${hipexamdetails.latleft}"  onkeypress="return validate(event)" name="latleft">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="5" name="latright" onkeypress="return validate(event)" value="${hipexamdetails.latright}" >&nbsp;&nbsp;Ant/lat leg</td><td>L5</td><td><input type="text" name="medleft" id="medleft" value="${hipexamdetails.medleft}"  onKeyPress="return check(id,event,value)" onInput="checkLength(id)" size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5"  onKeyPress="return check(id,event,value)" onInput="checkLength(id)" type="text" name="medright" id="medright" value="${hipexamdetails.medright}" >/5&nbsp;&nbsp;Glut Med</td><td>L5</td><td><input type="text" name="hsleft" id="check(id,event,value)" onInput="checkLength(id)" value="${hipexamdetails.hsleft}"  size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" onKeyPress="return check(id,event,value)" onInput="checkLength(id)" value="${hipexamdetails.hsright}"  name="hsright" id="hsright" size="5">/5&nbsp;&nbsp;Med HS</td></tr>
            <tr><td>S1</td><td><input size="5" type="text" value="${hipexamdetails.plantarleft}" onkeypress="return validate(event)"  name="plantarleft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${hipexamdetails.plantarright}"  onkeypress="return validate(event)" name="plantarright">&nbsp;&nbsp;Big toe/plantar</td><td>S1</td><td><input type="text"value="${hipexamdetails.maxleft}"  name="maxleft" id="maxleft" onKeyPress="return check(id,event,value)" onInput="checkLength(id)" size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input  size="5"type="text"  onKeyPress="return check(id,event,value)" onInput="checkLength(id)"value="${hipexamdetails.maxright}" id="maxright" name="maxright">/5&nbsp;&nbsp;Glut Max</td><td>S1</td><td><input type="text" onKeyPress="return check(id,event,value)" onInput="checkLength(id)" value="${hipexamdetails.achillesleft}"  name="achillesleft" id="achillesleft" size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${hipexamdetails.achillesright}" onKeyPress="return check(id,event,value)" onInput="checkLength(id)" name="achillesright" id="achillesright" >/5&nbsp;&nbsp;Achilles</td></tr>
