...
<div id="right_content">
 ...
 window.close();
				     ...
				     <tr class="title">
						...
						<c:if test="${fn:length(MedicalRecordsForm.medicalDetails) gt 0}">
        				  <c:forEach items="${MedicalRecordsForm.medicalDetails}" var="MedicalDetails" varStatus="status">
											...
											<a href="#" title=""><img src="resources/images/icons/icon_delete.png" alt="Delete" /></a><a href="<c:out value="deletemedicalrecordsdetails?medical_no=${MedicalDetails.medical_no}"/>" onclick="return confirmation()">Remove</a>
											</td>
	...
	<%-- <div class="extrabottom">
             ...
             <li class="page_unselect"><a href="medicalrecordslist_page?page=${currentpage - 1}" >Prev</a></li> 
               </c:if>
             ...
             <c:forEach var="count" begin="1" end="${noofrows}"> 
               <c:forEach begin="1" end="${noofpages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page_unselect"><a href="medicalrecordslist_page?page=${i}"><c:out value="${i}"></c:out></a></li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>          
            <c:if test="${currentpage!=noofpages}">
              <li class="page_unselect"><a href="medicalrecordslist_page?page=${currentpage+1}">Next</a></li> 
                 </c:if>
              <c:choose>
              <c:when test="${button=='viewall'}">
                  <li class="page"><a href="viewallmedicalrecordslist" class="paging_select">ViewAll</a></li>
             </c:when>
                <c:otherwise>
                  <li class="page"><a href="medicalrecordslist" class="paging_select">Back</a></li>
              </c:otherwise>
              </c:choose>
              </ul>
              </div> --%>
