      ...
      <tr>
        <td valign="top" align="left">
        	<div id="block1">
              ...
              <td valign="middle"  class="input_txt"><input type="text" id="datepicker" class="input_txtbx1" name="date"/><br><span id="datepickererror" style="color: red;font-style:italic;"><form:errors path="Hardshipagreement.date"></form:errors></td>
              </tr>
              </table>
              <br>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <td valign="middle"  class="input_txt"><input type="text" class="input_txtbx1" name="print_pat_name" id="print_pat_name" onInput="return validatename(id);" value="${name}"/><br><span id="print_pat_nameerror" style="color: red;font-style:italic;" ><form:errors path="Hardshipagreement.print_pat_name"></form:errors></span></td>
              </tr>
              </table>
              <br>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <td valign="middle"  class="input_txt"><input type="text" class="input_txtbx1" name="pat_sign" id="pat_sign" align="right" onInput="return validatesign(id);"/><br><span id="pat_signerror" style="color: red;font-style:italic;"><form:errors path="Hardshipagreement.pat_sign"></form:errors></td>
              </tr>
              </table>
              <br>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <td valign="middle"  class="input_txt"><input type="text" class="input_txtbx1" name="witness_sign" id="witness_sign" onInput="return validatesign(id);"/><br><span id="witness_signerror" style="color: red;font-style:italic;"><form:errors path="Hardshipagreement.witness_sign"></form:errors></td>
              </tr>
              </table>
              </c:when>
              <c:otherwise>
