...
<td valign="top" align="left">
 ...
 <tr class="row1">
<td><h2>Patient Name:</h2></td><td><input type="text" class="input_txtbx1" name="pname" /></td>
<td width="600">
<td><h2>Date:</h2></td><td><input type="text" class="input_txtbx1" id="datepicker" name="date" /></td>
</tr>
</table>
<br/>
<br/>
 ...
 <tr height="10">
 <tr>
 <td width="200">Gait:</td><td><select style="width:180px" name="gaitd" id="gaitd"  onchange='Checksymptom(this.value);'>
 ...
 <td>Assistive Device:<input type="text" name="assdevice" /></td><td><input type="checkbox" name="none" value="None"> None</td> 
 <td>Distance: <input type="text"  name="distance" /> </td><td><input type="checkbox" name="unlimited" value="Unlimited"> Unlimited</td>
 </tr>
 <tr height="10">
 <tr>
 ...
 <td></td>
 <td>A & O x 1 2 3 4:<select name="ao" id="ao"  onchange='Checksymptom(this.value);'>
 ...
 <tr height="10">
 <tr>
 <td width="200"><B style="font-size:14px">PALPATION / SOFT TISSUE</B></td><td width="200"><B style="font-size:14px"> DYSFUNCTION</B></td> 
 ...
 <td>Left:<select name="leglengthl" id="leglengthl"  onchange='Checksymptom(this.value);'>
					...
					<td>Right:<select name="leglengthr" id="leglengthr"  onchange='Checksymptom(this.value);'>
					<option selected="selected" value="1/8">1/8</option>
					<option value="1/4">1/4</option>
					<option value="3/8">3/8</option>
					<option value="1/2">1/2</option>
					...
					<td><input type="text" name="other2" id="other2" style='display:none'></td>
					<td></td>
 </tr>
 <tr height="10">
 <tr>
 <td>Piriformis:</td><td width="100"><input type="radio" name="piriformis" value="Right">Right  <input type="radio" name="piriformis" value="Left">Left</td> 
 
 <td>Quad Lumb:</td><td width="200"><input type="radio" name="quadlumb" value="Right">Right  <input type="radio" name="quadlumb" value="Left">Left</td> 
 
 <td>Paraspinals:</td><td width="100"><input type="radio" name="paraspinals" value="Right">Right  <input type="radio" name="paraspinals" value="Left">Left</td>
 </tr>
  <tr height="10">
 <tr>
 <td>Gluteus Maximus:</td><td><input type="radio" name="gluteus" value="Right">Right  <input type="radio" name="gluteus" value="Left">Left</td> 
 <td>Gluteus Medius:</td><td width="200"><input type="radio" name="gluteusmedius" value="Right">Right  <input type="radio" name="gluteusmedius" value="Left">Left</td> 
 <td>Hamstrings:</td><td><input type="radio" name="hamstrings" value="Right">Right <input type="radio" name="hamstrings" value="Left">Left</td>
 </tr>
<tr height="10">
 <tr>
 <td>Iliopsoas:</td><td><input type="radio" name="iliopsoas" value="Right">Right  <input type="radio" name="iliopsoas" value="Left">Left</td> 
 <td>Rectus Abdominis:	</td><td><input type="radio" name="rectus" value="Right">Right <input type="radio" name="rectus" value="Left">Left</td> 
 <td>Obliques:</td><td><input type="radio" name="obliques" value="Right">Right <input type="radio" name="obliques" value="Left">Left</td>
 </tr>
 </table>
 <table>
 <tr height="10">
 ...
 <tr height="10">
 <tr>
 <td width="80"><B style="font-size:14px">FUNCTIONAL RANGE OF </B> </td><td width="200"><B style="font-size:14px">MOTION</B></td> 
 <td width="150"><B style="font-size:14px">SUBLUXATION /DYSFUNCTION  </B></td><td width="150"></td> 
 <td><B style="font-size:14px">ORTHOTPEDIC </B></td><td><B style="font-size:14px">TESTING</B></td>
 </tr>
 <tr height="10">
  <tr>
 <td><input type="checkbox" name="unremarkable" value="Unremarkable">Unremarkable</td><td> <input type="checkbox" name="except" value="Except">Except</td> 
 <td><input type="checkbox" name="unremarkable" value="Unremarkable">Unremarkable</td><td><input type="checkbox" name="except" value="Except">Except </td> 
 <td> <input type="checkbox" name="unremarkable" value="Unremarkable">Unremarkable</td><td> <input type="checkbox" name="except" value="Except">Except</td>
 </tr>
 <tr height="10">
...
<td valign="top" align="left">
 <div>
	    ...
	    <div class="contentbox">
         ...
         <tr height="20">         
 <tr>
 <td><B style="font-size:14px">NEUROLOGICAL</B></td><td><input type="checkbox" name="neurologicaltest" value="Neurological Testing Unremarkable">Neurological Testing Unremarkable</td><td><input type="checkbox" name="except" value="Except">Except</td>
 <td></td><td></td><td></td>
 </tr>
 <tr height="10">
 <tr>
 ...
 <td> L4</td>
 <td> <input type="text" name="l4l" size="5">&nbsp;/5&nbsp; &nbsp; &nbsp;<input type="text" name="l4r" size="5">&nbsp;/5&nbsp;(Patellar)</td>
 </tr>
  <tr height="10">
 <tr>
 <td>L5</td>
 ...
 <td>L5 </td>
 <td><input type="text" name="l5l" size="5">&nbsp;/5&nbsp; &nbsp; &nbsp;<input type="text" name="l5r" size="5">&nbsp;/5&nbsp;(Med HS) </td>
 </tr>
  <tr height="10">
 <tr>
 <td>SI</td>
...
<table>
 ...
 <tr height="20">         
 <tr>
 <td>Patient's Status for being a candidate for conservative care:	</td><td><select name="leglength" id="leglength"  onchange='Checksymptom(this.value);'>
					<option selected="selected" value="Excellent" >Excellent</option>
					<option value="Good">Good</option>
					<option value="Fair">Fair</option>
...
<tr height="10">
 ...
 <br/>
 <div><B style="font-size:14px">PHYSICIAN SIGNATURE: &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="sign"></B></div>
 </div>
</div>
</form>
</body>