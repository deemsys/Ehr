...
<td valign="top" align="left">
 ...
 <tr class="row1">
<td style="width: 354px; "><h4><span class="err">*</span>&nbsp;&nbsp;Patient Name:</h4></td><td style="width: 199px; "><input type="text"  name="pname" id="pname" onInput="return validatename(id)";/><br><span class="err" id="pnameerror"><form:errors path="Cervicalexam.pname"></form:errors></span></td>
<td width="600" style="width: 303px; ">
<td><h4><span class="err">*</span>&nbsp;&nbsp;Date:</h4></td><td><input type="text"  id="datepicker" name="date" /><br><span class="err" id="datepickererror"><form:errors path="Cervicalexam.date"></form:errors></span></td>
</tr>
</table>
<br/>
<br/>
...
<input type="checkbox" name="driving" value="Driving">Driving&nbsp;<input type="checkbox" name="computeruse" value="Computer Use">Computer Use&nbsp;
 ...
 <br/>
 <table><tr><td><B style="font-size:14px"><span class="err">*</span>PHYSICIAN SIGNATURE: &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="sign" id="sign" onInput="return validatename(id)";><br><span class="err" id="signerror"><form:errors path="Cervicalexam.sign"></form:errors></span></B></td></tr></table>
<table align="right">
<tr>
