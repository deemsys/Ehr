...
<br><br>
    ...
    <br> </td></tr>
     ...
     <tr><td><input type="checkbox" class="input_ckbx1" name="date" id="date"></td><td>Other: (Describe)<input type="text" class="input_txtbx1" name="other1" id="other1" style="width: 483px; "><span class="err"><form:errors path="Requestfordemand.other1"></form:errors></span><br><br>
     </td></tr>
      <tr><td></td><td><input type="text" class="input_txtbx1" name="other2" id="other2" style="width: 593px; "><span class="err"><form:errors path="Requestfordemand.other2"></form:errors></span><br><br>
     </td></tr>
      <tr><td></td><td><input type="text" class="input_txtbx1" name="other3" id="other3" style="width: 593px; "><span class="err"><form:errors path="Requestfordemand.other3"></form:errors></span><br><br>
     </td></tr>
      <tr><td></td><td><input type="text" class="input_txtbx1" name="other4" id="other4" style="width: 593px; "><span class="err"><form:errors path="Requestfordemand.other4"></form:errors></span><br><br>
     </td></tr>
     ...
     <tr><td><input type="inputtype" class="input_ckbx1" name="copymedpay" id="copymedpay"><span class="err"><form:errors path="Requestfordemand.copymedpay"></form:errors></span></td><td>Copy of Med Pay and At Fault Form Cover Letter
     <br><br></td></tr>
     
     <tr><td><input type="inputtype" class="input_ckbx1" name="copyform" id="copyform"><span class="err"><form:errors path="Requestfordemand.copyform"></form:errors></span><br></td><td>Copy of Form Cover Letter sent to the Attorney
     <br><br></td></tr>
     ...
     <br><br></td></tr>
      ...
      <tr><td><input type="inputtype" class="input_ckbx1" name="greencard" id="greencard"><span class="err"><form:errors path="Requestfordemand.greencard"></form:errors></span></td><td>Front and back of Certified Mail: “Green Card”
     <br><br></td></tr>
