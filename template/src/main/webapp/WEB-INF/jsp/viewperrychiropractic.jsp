        		...
        		<td valign="top" align="left">
			      ...
			      <form action="" method="POST"> 
				     ...
				     <tr class="title">
						...
						<c:if test="${fn:length(perrychiropracticform.perrychiropracticdetails) gt 0}">
        				 <c:forEach items="${perrychiropracticform.perrychiropracticdetails}" var="perrychiropracticdetails" varStatus="status">
        				       				<tr class="row1">
        				       				<td valign="top" align="left" width="10%"><a href="perrychiropracticlist?perryid=${perrychiropracticdetails.perryid}"> ${perrychiropracticdetails.perryid}</td>
								            <td valign="top" align="left"  width="10%"><%-- <a href="hipexamlist?hipexamno=${perrychiropracticdetails.hipexamno}"> --%>${perrychiropracticdetails.nameofperson}</td>
											
											<td valign="top" align="left" width="10%">${perrychiropracticdetails.dateofaccident}</td>
							    ...
							    <c:if test="${fn:length(perrychiropracticform.perrychiropracticdetails) == 0}">	
							    	<tr class="row1">
