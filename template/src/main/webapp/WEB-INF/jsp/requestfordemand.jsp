...
<br><br>
    ...
    <br> </td></tr>
     ...
     <tr><td><input type="checkbox" class="input_ckbx1" name="date" id="date"></td><td>Other: (Describe)<input type="text" class="input_txtbx1" name="other1" id="other1" style="width: 483px; "><br><br>
     </td></tr>
      <tr><td></td><td><input type="text" class="input_txtbx1" name="other2" id="other2" style="width: 593px; "><br><br>
     </td></tr>
      <tr><td></td><td><input type="text" class="input_txtbx1" name="other3" id="other3" style="width: 593px; "><br><br>
     </td></tr>
      <tr><td></td><td><input type="text" class="input_txtbx1" name="other4" id="other4" style="width: 593px; "><br><br>
     </td></tr>
     ...
     <tr><td><input type="inputtype" class="input_ckbx1" name="copymedpay" id="copymedpay"></td><td>Copy of Med Pay and At Fault Form Cover Letter
     <br><br></td></tr>
     
     <tr><td><input type="inputtype" class="input_ckbx1" name="copyform" id="copyform"><br></td><td>Copy of Form Cover Letter sent to the Attorney
     <br><br></td></tr>
     
      <tr><td><input type="inputtype" class="input_ckbx1" name="copyassign" id="copyassign"></td><td>Copy of Assignment
     <br><br></td></tr>
     
      <tr><td><input type="inputtype" class="input_ckbx1" name="greencard" id="greencard"></td><td>Front and back of Certified Mail: “Green Card”
     <br><br></td></tr>
     
      <tr><td><input type="inputtype" class="input_ckbx1" name="defaultattorney" id="default"></td><td>Any correspondence from the defaulting Adjuster or Defaulting Attorney
    <br><br> </td></tr>
     ...
     <tr><td style="width: 400px; "></td><td align="right" ><input type="inputtype" class="input_ckbx1" name="clinicrep" id="clinicrep" style="width: 250px; "></td></tr>
