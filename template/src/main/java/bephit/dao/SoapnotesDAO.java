...
public class SoapnotesDAO {
	...
	public int setSoapnotes(SoapNotes soapnotes)
	{
	    ...
	    try{
	    	 ...
	    	 Date date = new Date();	    	 
	    	 String cmd="INSERT INTO `tbl_soapnotes`(`patient_id`,`pname`,`headache`,`neckpain`,`rightshoulderpain`,`leftshoulderpain`,`chestpain`,`rightarmpain`,`leftarmpain`,`rightelbowpain`,`leftelbowpain`,`rightwristpain`,`leftwristpain`,`righthandpain`,`lefthandpain`,`mbp`,`rightribpain`,`leftribpain`,`lbp`,`rightsipain`,`leftsipain`,`righthippain`,`lefthippain`,`rightgluteulpain`,`leftgluteulpain`,`rightlegpain`,`leftlegpain`,`rightkneepain`,`leftkneepain`,`rightanklepain`,`leftanklepain`,`rightfootpain`,`leftfootpain`,`date1`,`improved`,`worsened`,`painscale`,`diagnosis1`,`diagnosis2`,`diagnosis3`,`diagnosis4`,`e1e2`,`offwork1`,`reeval1`,`date2`,`improved1`,`worsened1`,`fixation1`,`notimproved1`,`scsm1`,`date3`,`improved2`,`worsened2`,`fixation2`,`notimproved2`,`scsm2`,`date4`,`improved3`,`worsened3`,`fixation3`,`notimproved3`,`scsm3`,`date5`,`improved4`,`worsened4`,`fixation4`,`notimproved4`,`scsm4`,`date6`,`improved5`,`worsened5`,`fixation5`,`notimproved5`,`scsm5`,`date7`,`improved6`,`worsened6`,`fixation6`,`notimproved6`,`scsm6`,`date8`,`improved7`,`worsened7`,`fixation7`,`notimproved7`,`scsm7`,`date9`,`improved8`,`worsened8`,`fixation8`,`notimproved8`,`scsm8`,`sign`)VALUES ('"+soapnotes.getPatient_id()+"','"+soapnotes.getPname()+"','"+soapnotes.getHeadache()+"','"+soapnotes.getNeckpain()+"','"+soapnotes.getRightshoulderpain()+"','"+soapnotes.getLeftshoulderpain()+"','"+soapnotes.getChestpain()+"','"+soapnotes.getRightarmpain()+"','"+soapnotes.getLeftarmpain()+"','"+soapnotes.getRightelbowpain()+"','"+soapnotes.getLeftelbowpain()+"','"+soapnotes.getRightwristpain()+"','"+soapnotes.getLeftwristpain()+"','"+soapnotes.getRighthandpain()+"','"+soapnotes.getLefthandpain()+"','"+soapnotes.getMbp()+"','"+soapnotes.getRightribpain()+"','"+soapnotes.getLeftribpain()+"','"+soapnotes.getLbp()+"','"+soapnotes.getRightsipain()+"','"+soapnotes.getLeftsipain()+"','"+soapnotes.getRighthippain()+"','"+soapnotes.getLefthippain()+"','"+soapnotes.getRightgluteulpain()+"','"+soapnotes.getLeftgluteulpain()+"','"+soapnotes.getRightlegpain()+"','"+soapnotes.getLeftlegpain()+"','"+soapnotes.getRightkneepain()+"','"+soapnotes.getLeftkneepain()+"','"+soapnotes.getRightanklepain()+"','"+soapnotes.getLeftanklepain()+"','"+soapnotes.getRightfootpain()+"','"+soapnotes.getLeftfootpain()+"','"+soapnotes.getDate1()+"','"+soapnotes.getImproved()+"','"+soapnotes.getWorsened()+"','"+soapnotes.getPainscale()+"','"+soapnotes.getDiagnosis1()+"','"+soapnotes.getDiagnosis2()+"','"+soapnotes.getDiagnosis3()+"','"+soapnotes.getDiagnosis4()+"','"+soapnotes.getE1e2()+"','"+soapnotes.getOffwork1()+"','"+soapnotes.getReeval1()+"','"+soapnotes.getDate2()+"','"+soapnotes.getImproved1()+"','"+soapnotes.getWorsened1()+"','"+soapnotes.getFixation1()+"','"+soapnotes.getNotimproved1()+"','"+soapnotes.getScsm1()+"','"+soapnotes.getDate3()+"','"+soapnotes.getImproved2()+"','"+soapnotes.getWorsened2()+"','"+soapnotes.getFixation2()+"','"+soapnotes.getNotimproved2()+"','"+soapnotes.getScsm2()+"','"+soapnotes.getDate4()+"','"+soapnotes.getImproved3()+"','"+soapnotes.getWorsened3()+"','"+soapnotes.getFixation3()+"','"+soapnotes.getNotimproved3()+"','"+soapnotes.getScsm3()+"','"+soapnotes.getDate5()+"','"+soapnotes.getImproved4()+"','"+soapnotes.getWorsened4()+"','"+soapnotes.getFixation4()+"','"+soapnotes.getNotimproved4()+"','"+soapnotes.getScsm4()+"','"+soapnotes.getDate6()+"','"+soapnotes.getImproved5()+"','"+soapnotes.getWorsened5()+"','"+soapnotes.getFixation5()+"','"+soapnotes.getNotimproved5()+"','"+soapnotes.getScsm5()+"','"+soapnotes.getDate7()+"','"+soapnotes.getImproved6()+"','"+soapnotes.getWorsened6()+"','"+soapnotes.getFixation6()+"','"+soapnotes.getNotimproved6()+"','"+soapnotes.getScsm6()+"','"+soapnotes.getDate8()+"','"+soapnotes.getImproved7()+"','"+soapnotes.getWorsened7()+"','"+soapnotes.getFixation7()+"','"+soapnotes.getNotimproved7()+"','"+soapnotes.getScsm7()+"','"+soapnotes.getDate9()+"','"+soapnotes.getImproved8()+"','"+soapnotes.getWorsened8()+"','"+soapnotes.getFixation8()+"','"+soapnotes.getNotimproved8()+"','"+soapnotes.getScsm8()+"','"+soapnotes.getSign()+"')";
