      ...
      <tr>
        <td valign="top" align="left">
        	<div>
              ...
              <br>
              <tr><p>Hi, I'm calling to verify chiropractic benefits for Mr./ Mrs.<input type="text" class="input_txtbx1" name="verify_name" id="verify_name" /></p></tr>
              <tr class="row1">
              <td>Spoke with</td>
              <td><input type="text" class="input_txtbx1" name="spoke_with" id="spoke_with" /></td>
              <td>Date</td>
              <td><input type="text" class="input_txtbx1" name="date" id="datepicker" /></td>
              <td>Fax#</td>
              <td><input type="text" class="input_txtbx1" name="fax" id="fax" /></td>
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr class="row1">
              ...
              <td><input type="text" class="input_txtbx1" name="amount_deduct" id="amount_deduct" /></td>
              <td>Amount of deductible met</td>
              <td><input type="text" class="input_txtbx1" name="amount_deduct_met" id="amount_deduct_met" /></td>
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr class="row1">
              <td>Maximum visits/year?</td>
              <td><input type="text" class="input_txtbx1" name="max_visit" id="max_visit" /></td>
              </tr>
              <tr class="row1">
              ...
              <td>At what%?</td>
              <td><input type="text" class="input_txtbx1" name="at_what" id="at_what" />
              </tr>
              <tr class="row1">
              ...
              <td>At what%?</td>
              <td><input type="text" class="input_txtbx1" name="atwhat" id="atwhat" /></td>
              <td>Subject to deductible</td>
              <td><input type="text" class="input_txtbx1" name="subject_deduct" id="subject_deduct" />
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr class="row1">
             ...
             <td><input type="radio" name="network_benefits" value="0" class="input_txt" checked="true">Yes&nbsp;&nbsp;&nbsp;<input type="radio" name="network_benefits" value="1" class="input_txt">No</td>
              ...
              <tr class="row1">
              <td>Deuctible</td>
              <td><input type="text" class="input_txtbx1" name="deductible" id="deductible" /></td>
              <td>%covered</td>
              <td><input type="text" class="input_txtbx1" name="covered" id="covered" /></td>
              </tr>
              <tr class="row1">
             ...
             <td><input type="radio" name="doctors_assign" value="0" class="input_txt" checked="true">Yes&nbsp;&nbsp;&nbsp;<input type="radio" name="doctors_assign" value="1" class="input_txt">No</td>
              ...
              <td><textarea rows="3" cols="35" name="mail_claims" id="mail_claims" ></textarea></td>
              </tr>
               <tr>
