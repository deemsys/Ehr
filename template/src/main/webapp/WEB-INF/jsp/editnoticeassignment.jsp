        ...
        <td valign="top" align="center">
        	<div>
             ...
             <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <td ><input type="hidden" name="noticeid" value="${noticeassignmentdetails.noticeid }"><input type="text" class="input_txtbx1" name="nameofins" value="${noticeassignmentdetails.nameofins }" id="name" /><span class="err"><form:errors path="noticeofassignment.name"></form:errors></td>
              <td height="40" width="110" ><span class="err">&nbsp;&nbsp;*</span>Name Of Attorney:</td>
              <td >&nbsp;&nbsp;<input type="text" class="input_txtbx1" name="nameofattorney" value="${noticeassignmentdetails.nameofattorney }" id="name" /><span class="err"><form:errors path="noticeofassignment.nameofattorney"></form:errors></span></td>
              </tr>
              </table>
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
          ...
          <tr>
            <td height="40" width="180"><span class="err">*</span>PatientName:</td>
              <td ><input type="text" class="input_txtbx1" name="patientname"value= "${noticeassignmentdetails.patientname }" id="patientname" /><span class="err"><form:errors path="noticeofassignment.patientname"></form:errors></span></td>                      
          </tr> 
          <tr>
          ...
          <tr>
            <td height="20" width="180"><span class="err">*</span>Today'sDate:</td>
              <td ><input type="text" class="input_txtbx1" name="todaysdate"value="${noticeassignmentdetails.todaysdate }" id="todaysdate" /><span class="err"><form:errors path="noticeofassignment.todaysdate"></form:errors></span></td>                      
          </tr> <br>  
            </table>
...
do not receive a response, we will act in reliance that you will comply with it's instructions.
           ...
           <p> <b>
              ...
              <input type="text" class="input_txtbx1" name="treatingphysician" value="${noticeassignmentdetails.treatingphysician }" id="treatingphysician" /><span class="err"><form:errors path="responseattorney.treatingphysician"></form:errors></td>
              </tr><br>
              </table>
