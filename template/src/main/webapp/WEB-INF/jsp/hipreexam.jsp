...
<table id="softtissue" >	
	...
	<table  style="border:10">      
         ...
         <tr height="10"></tr>
         <tr><td>Flexion:		</td><td>100</td><td><input type="text" size="5" value="${hipexamdetails.flexionleft}"name="flexionleft" onkeypress="return isNumberKey(event)">&nbsp;&nbsp;&nbsp;&nbsp;<input value="${hipexamdetails.flexionright}"  onkeypress="return isNumberKey(event)" size="5" type="text" name="flexionright"></td><td width="90"></td><td>Patrick Fabere:	</td><td width="150"></td><td><input size="5" type="text"  name="fabereleft" onkeypress="return isNumberKey(event)" value="${hipexamdetails.fabereleft}">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${hipexamdetails.fabereleft}"  onkeypress="return isNumberKey(event)" size="5" name="fabereright"></td></tr>
         <tr><td>Extension:			</td><td>30</td><td><input size="5" type="text" onkeypress="return isNumberKey(event)" value="${hipexamdetails.extensionleft}" name="extensionleft">&nbsp;&nbsp;&nbsp;&nbsp;<input value="${hipexamdetails.extensionright}" size="5" type="text" name="extensionright" onkeypress="return isNumberKey(event)"></td><td width="90"></td><td>Nachlas:</td><td width="150"></td><td><input type="text"  size="5" name="nachlasleft" value="${hipexamdetails.nachlasleft}" onkeypress="return isNumberKey(event)">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${hipexamdetails.nachlasright}" size="5" onkeypress="return isNumberKey(event)"  name="nachlasright"></td></tr>
         <tr><td>Abduction:				</td><td>45</td><td><input size="5" type="text" onkeypress="return isNumberKey(event)" name="abductionleft" value="${hipexamdetails.abductionright}">&nbsp;&nbsp;&nbsp;&nbsp;<input value="${hipexamdetails.abductionleft}"  size="5" type="text" name="abductionright" onkeypress="return isNumberKey(event)"></td><td width="90"></td><td>Ely's:</td><td width="150"></td><td><input type="text" size="5"  onkeypress="return isNumberKey(event)"  name="elysleft" value="${hipexamdetails.elysleft}">&nbsp;&nbsp;&nbsp;&nbsp;<input value="${hipexamdetails.elysright}" onkeypress="return isNumberKey(event)" size="5" type="text"  name="elysright"></td></tr>
         <tr><td>Adduction:				</td><td>30</td><td><input size="5" type="text" onkeypress="return isNumberKey(event)" value="${hipexamdetails.adductionleft}" name="adductionleft">&nbsp;&nbsp;&nbsp;&nbsp;<input value="${hipexamdetails.adductionright}" onkeypress="return isNumberKey(event)" size="5" type="text" name="adductionright"></td><td width="90"></td><td>Yeoman's:</td><td width="150"></td><td><input type="text" size="5" onkeypress="return isNumberKey(event)"  value="${hipexamdetails.yeomansleft}" name="yeomansleft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" onkeypress="return isNumberKey(event)" value="${hipexamdetails.yeomansright}" name="yeomansright"></td></tr></tr>
         <tr><td>Internal Rotation:</td><td>40</td><td><input type="text" size="5" onkeypress="return isNumberKey(event)" name="internalrotationleft" value="${hipexamdetails.internalrotationleft}">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" onkeypress="return isNumberKey(event)" value="${hipexamdetails.internalrotationright}" name="internalrotationright"><td width="90"></td><td>Ober's:	</td><td width="150"></td><td><input type="text" size="5" onkeypress="return isNumberKey(event)" value="${hipexamdetails.obersleft}" name="obersleft">&nbsp;&nbsp;&nbsp;&nbsp;<input  value="${hipexamdetails.obersright}" onkeypress="return isNumberKey(event)" type="text" size="5" name="obersright"></td></td></tr>
         <tr><td>External Rotation:</td><td>45</td><td><input type="text" size="5" onkeypress="return isNumberKey(event)" name="externalrotationleft" value="${hipexamdetails.externalrotationleft}">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" onkeypress="return isNumberKey(event)" value="${hipexamdetails.externalrotationright}" name="externalrotationright"></td><td width="90"></td><td>	Hibbs:</td><td width="150"></td><td><input type="text" size="5" onkeypress="return isNumberKey(event)"  value="${hipexamdetails.hibbsleft}" name="hibbsleft">&nbsp;&nbsp;&nbsp;&nbsp;<input  value="${hipexamdetails.hibbsright}"size="5" type="text" onkeypress="return isNumberKey(event)"  name="hibbsright"></td></tr>
          <tr><td></td><td></td><td>&nbsp;&nbsp;</td><td width="90"></td><td>Thomas:</td><td width="150"></td><td><input type="text" onkeypress="return isNumberKey(event)" size="5" value="${hipexamdetails.thomasleft}" name="thomasleft">&nbsp;&nbsp;&nbsp;&nbsp;<input value="${hipexamdetails.thomasright}" onkeypress="return isNumberKey(event)" type="text" size="5" name="thomasright"></td></tr>
         </table>
         </td></tr></table></div></div>
        <div id="tabs-2">     
 ...
 <div>
        ...
        <tr>
         ...
         <td width="246"><input type="checkbox"   <c:if test="${hipexamdetails.neurological=='Neurological Testing Unremarkable'}"> <c:out value="checked=checked"></c:out></c:if> id=neurologicalunremarkable name="neurological" value="Neurological Testing Unremarkable">Neurological Testing Unremarkable</td>
          ...
          <tr height="10"></tr>
           <tr><td>L1</td><td><input type="text" value="${hipexamdetails.inguinalarealeft}"  size="5" onkeypress="return isNumberKey(event)" name="inguinalarealeft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${hipexamdetails.inguinalarearight}" onkeypress="return isNumberKey(event)"  name="inguinalarearight">&nbsp;&nbsp; Inguinal area</td><td>L1</td><td><input size="5" type="text" value="${hipexamdetails.iliopsoasfirstleft}"  onkeypress="return isNumberKey(event)" name="iliopsoasfirstleft">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"  onkeypress="return isNumberKey(event)" size="5" value="${hipexamdetails.iliopsoasfirstright}" name="iliopsoasfirstright">/5&nbsp;&nbsp; Iliopsoas</td><td></td><td></td></tr>
           <tr><td>L2</td><td><input size="5" type="text" value="${hipexamdetails.antleft}" onkeypress="return isNumberKey(event)" name="antleft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" value="${hipexamdetails.antright}" onkeypress="return isNumberKey(event)" type="text" name="antright">&nbsp;&nbsp;Ant/med thigh</td><td>L2</td><td><input type="text" onkeypress="return isNumberKey(event)" name="iliopsoas1left" value="${hipexamdetails.iliopsoas1left}"  size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" onkeypress="return isNumberKey(event)" value="${hipexamdetails.iliopsoas1right}"  type="text" name="iliopsoas1right">/5&nbsp;&nbsp;Iliopsoas</td><td></td><td>&nbsp;(2+/5 is Normal)</td></tr>
           <tr><td>L3</td><td><input type="text" value="${hipexamdetails.kneeleft}" onkeypress="return isNumberKey(event)"   name="kneeleft" size="5">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" onkeypress="return isNumberKey(event)" value="${hipexamdetails.kneeright}"  name="kneeright">&nbsp;&nbsp;Medial knee</td><td>L3</td><td><input type="text" onkeypress="return isNumberKey(event)" name="iliopsoas2left" value="${hipexamdetails.iliopsoas2left}"  size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" onkeypress="return isNumberKey(event)" type="text" value="${hipexamdetails.iliopsoas2right}"  name="iliopsoas2right">/5&nbsp;&nbsp;Iliopsoas</td><td></td><td>&nbsp; </td></tr>
           <tr><td>L4</td><td><input type="text" size="5" value="${hipexamdetails.medialleft}" onkeypress="return isNumberKey(event)"  name="medialleft">&nbsp;&nbsp;&nbsp;&nbsp;<input  size="5"type="text" onkeypress="return isNumberKey(event)"  value="${hipexamdetails.medialright}"  name="medialright">&nbsp;&nbsp;Medial leg</td><td>L4</td><td><input type="text"  onkeypress="return isNumberKey(event)" value="${hipexamdetails.femleft}"  name="femleft" size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" onkeypress="return isNumberKey(event)" value="${hipexamdetails.femright}"   name="femright">/5&nbsp;&nbsp;Rectus Fem</td><td>L4</td><td><input type="text" value="${hipexamdetails.patellarleft}" onkeypress="return isNumberKey(event)"  name="patellarleft" size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${hipexamdetails.patellarright}" onkeypress="return isNumberKey(event)"  name="patellarright" size="5">/5&nbsp;&nbsp;Patellar</td></tr>
            <tr><td>L5</td><td><input type="text" size="5" value="${hipexamdetails.latleft}"  onkeypress="return isNumberKey(event)" name="latleft">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="5" name="latright" onkeypress="return isNumberKey(event)" value="${hipexamdetails.latright}" >&nbsp;&nbsp;Ant/lat leg</td><td>L5</td><td><input type="text" name="medleft"  value="${hipexamdetails.medleft}" onkeypress="return isNumberKey(event)"  size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" onkeypress="return isNumberKey(event)"  type="text" name="medright" value="${hipexamdetails.medright}" >/5&nbsp;&nbsp;Glut Med</td><td>L5</td><td><input type="text" name="hsleft" onkeypress="return isNumberKey(event)" value="${hipexamdetails.hsleft}"  size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${hipexamdetails.hsright}" onkeypress="return isNumberKey(event)" name="hsright"  size="5">/5&nbsp;&nbsp;Med HS</td></tr>
            <tr><td>S1</td><td><input size="5" type="text" value="${hipexamdetails.plantarleft}" onkeypress="return isNumberKey(event)"  name="plantarleft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${hipexamdetails.plantarright}"  onkeypress="return isNumberKey(event)" name="plantarright">&nbsp;&nbsp;Big toe/plantar</td><td>S1</td><td><input type="text"value="${hipexamdetails.maxleft}"  name="maxleft" onkeypress="return isNumberKey(event)" size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input  size="5"type="text" onkeypress="return isNumberKey(event)" value="${hipexamdetails.maxright}"  name="maxright">/5&nbsp;&nbsp;Glut Max</td><td>S1</td><td><input type="text" value="${hipexamdetails.achillesleft}" onkeypress="return isNumberKey(event)" name="achillesleft" size="5">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${hipexamdetails.achillesright}" onkeypress="return isNumberKey(event)" name="achillesright">/5&nbsp;&nbsp;Achilles</td></tr>
