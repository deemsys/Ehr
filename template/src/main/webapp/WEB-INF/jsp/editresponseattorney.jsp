      ...
      <tr>
        <td valign="top" align="left">
        	<div>
              ...
              <td ><input type="hidden" name="responseid" value="${responseattorneydetail.responseid }"><input type="text" class="input_txtbx1" name="name" value="${responseattorneydetail.name }" id="name" /><span class="err"><form:errors path="Hardshipagreement.date"></form:errors></td>
              </tr>
              <tr>
              <td height="20" width="120"><span class="err">*</span>Address:</td>
              <td ><input type="text" class="input_txtbx1" name="address" value="${responseattorneydetail.address }" id="address" /><span class="err"><form:errors path="Hardshipagreement.date"></form:errors></td>
              </tr>
              <tr>
              <td height="20" width="120"></td>
              <td><input type="text" class="input_txtbx1" name="address1" value="${responseattorneydetail.address1 }" id="address1" /><span class="err"><form:errors path="Hardshipagreement.date"></form:errors></td></td></tr>
            
              <tr>  <td height="30" width="120"></td><td><input type="text" class="input_txtbx1" name="address2" value="${responseattorneydetail.address2 }" id="address2" /><span class="err"><form:errors path="Hardshipagreement.date"></form:errors></td></td></tr>
             <tr>
              ...
              <td ><input type="text" class="input_txtbx1" name="patientname" value="${responseattorneydetail.patientname }" id="patientname" /><span class="err"><form:errors path="Hardshipagreement.date"></form:errors></td>
              </tr>
                <tr>
              <td height="30" width="120"><span class="err">*</span>Date Of Accident:</td>
              <td ><input type="text" class="input_txtbx1" name="dateofaccident" value="${responseattorneydetail.dateofaccident }" id="dateofaccident" /><span class="err"><form:errors path="Hardshipagreement.date"></form:errors></td>
              </tr>
              </table>
              ...
              <input type="text" class="input_txtbx1" name="nameofclinic" value="${responseattorneydetail.nameofclinic }" id="nameofclinic" /><span class="err"><form:errors path="Hardshipagreement.pat_sign"></form:errors></span></td>
              </tr>
              </table>
              <br>
               <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <input type="text" class="input_txtbx1" name="treatingphysician" value="${responseattorneydetail.treatingphysician }" id="treatingphysician" /><span class="err"><form:errors path="Hardshipagreement.pat_sign"></form:errors></span></td>
              </tr>
              </table>
