      ...
      <tr>
        <td valign="top" align="center">
        	...
        	<c:set value="${patientattorneyform.patientattorneydetails[0]}" var="patientattorneydetails"> </c:set>
              ...
              <td ><textarea rows="" cols="" name="address" class="input_txtarea" id="address"style="width: 162px; height: 62px">${patientattorneydetails.address }</textarea><span class="err"><form:errors path="Patientattorney.address"></form:errors></span></td>
              </tr>
              </table>
              ...
              <td ><input type="text" class="input_txtbx1" name="patientname" value="${patientattorneydetails.patientname}"    id="patientname"><span class="err"id="patientnameerror"  style="color: red;font-style:italic;"><form:errors path="Patientattorney.patientname"></form:errors></span></td>
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
