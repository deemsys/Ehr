      ...
      <tr>
        <td valign="top" align="center">
        	<div>
              ...
              <td ><input type="text" class="input_txtbx1" name="reg" id="reg"><span class="err"><form:errors path="Patientattorney.address"></form:errors></span></td>
              </tr>
              </table>
...
Opinion 2007-7 provides the following further ethical directions: 
             ...
             <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <tr ><td width="70%"></td><td><input type="text" class="input_txtbx1" name="nameofclinic" id="nameofclinic"></td></tr>
              <tr><td></td><td>Name of Clinic</td>
              </tr>
              
               <tr ><td width="70%"></td><td><input type="text" class="input_txtbx1" name="treat" id="treat"></td></tr>
