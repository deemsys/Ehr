      ...
      <tr>
        <td valign="top" align="left">
        	<div>
              ...
              <td ><input type="text" class="input_txtbx1" name="patientname" value="${responseattorneydetail.patientname }" id="patientname"  style="width: 156px; " onInput="return validatename()";/><span class="err" id="patientnameerror"><form:errors path="Responseattorney.patientname"></form:errors></td>
              </tr>
                <tr>
