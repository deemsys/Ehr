      ...
      <tr>
        <td valign="top" align="center">
        	<div>
              ...
              <td ><input type="text" class="input_txtbx1" name="faxno" value="${faxcoverdetails.faxno }" id="datepicker" /><span class="err"><form:errors path="Hardshipagreement.date"></form:errors></td>
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
     ...
     <table cellpadding="0" cellspacing="0" border="0" width="100%">
     	...
     	<table cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <td ><span class="err">*</span>Claim No:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
              <td ><input type="text" class="input_txtbx1" name="claimno"value="${faxcoverdetails.claimno }" id="datepicker" /><span class="err"><form:errors path="Hardshipagreement.date"></form:errors></td>
             <tr>
              <td height="25" width="120"><span class="err">*</span>DOI</td>
              <td ><input type="text" class="input_txtbx1" name="doi" value="${faxcoverdetails.doi }" id="datepicker" /><span class="err"><form:errors path="Hardshipagreement.date"></form:errors></td>
             </tr>
              </tr>
