        ...
        <td valign="top" align="center">
        	<div>
        	  ...
        	  <tr><td hight="20" width="250"><br><br><p align="left" id="mypar"><b><h4>Dear Ms Barbara Wilmoth:</h4></b></p></td></tr>
       		 ...
       		 <tr><td>
       		 <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;         Attached you will find itemized charges for your care. To avoid legal action, please submit payment. To avoid legal action, please submit payment in full to Chiropractic Therapy Center. Your total bill to be paid to Chiropractic Therapy Center is <input type="hidden" name="letterid" value="${lettertopatientsdetails.letterid }"/><input type="text" class="input_txtbx1" name="letter" value="${lettertopatientsdetails.letter }" id="letter" />.<span class="err"><%-- <form:errors path="lettertopatient.letter"></form:errors> --%> </span>
       		 </p>
       		 </td>
       		 </tr>
       		 <tr><td>
