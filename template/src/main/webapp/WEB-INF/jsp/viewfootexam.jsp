...
window.close();
        		...
        		<td valign="top" align="left">
			      ...
			      <form action="physicalexam" method="POST"> 
				     ...
				     <tr class="title">
						...
						<c:if test="${fn:length(footexamform.footexamdetails) gt 0}">
        				 <c:forEach items="${footexamform.footexamdetails}" var="footexamdetails" varStatus="status">
        				       				<tr class="row1">
        				       				<td valign="top" align="left" width="10%">${footexamdetails.footexamno}</td>
								            <td valign="top" align="left"  width="10%"><a href="footexamlist?footexamno=${footexamdetails.footexamno}">${footexamdetails.pname}</a></td>
							    ...
							    <c:if test="${fn:length(footexamform.footexamdetails) == 0}">	
							    	<tr class="row1">
	...
	<div class="extrabottom">
             ...
             <li class="page_unselect"><a href="viewfootexam_page?page=${currentpage - 1}" >Prev</a></li> 
               </c:if>
             ...
             <%-- <c:forEach var="count" begin="1" end="${noofrows}">  --%>
               <c:forEach begin="1" end="${noofpages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page_unselect"><a href="viewfootexam_page?page=${i}"><c:out value="${i}"></c:out></a></li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>          
            <c:if test="${currentpage!=noofpages}">
              <li class="page_unselect"><a href="viewfootexam_page?page=${currentpage+1}">Next</a></li> 
                 </c:if>
              <c:choose>
              <c:when test="${button=='viewall'}">
                  <li class="page"><a href="viewallfootexam" class="paging_select">ViewAll</a></li>
             </c:when>
                <c:otherwise>
                  <li class="page"><a href="viewfootexam" class="paging_select">Back</a></li>
              </c:otherwise>
              </c:choose>
							 </table>
							 </form>
