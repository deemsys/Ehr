...
<table>         
 ...
 <td> <input type="text" id="break3" name="break_text3" style="visibility:hidden" value="${elbowexam.break_text3}" /></td>
 <td width="150"></td>
 <td width="150"></td>
 </tr>          
 <tr class="row1">
