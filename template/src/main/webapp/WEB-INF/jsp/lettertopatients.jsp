...
<c:when test="${empty letterto}">
              ...
              <td ><input type="text" class="input_txtbx1" name="re" id="re" placeholder="Medical bill" /><span class="err"><form:errors path="Lettertopatients.re"></form:errors></span></td>
              </tr>
              </table>
              ...
              <td ><input type="text" class="input_txtbx1" name="ssn" id="ssn" placeholder="298-70-2433" /><span class="err"><form:errors path="Lettertopatients.ssn"></form:errors></span></td>
              </tr>
              </table>
               <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="120"><span class="err">*</span>Claim:</td>
              <td ><input type="text" class="input_txtbx1" name="claim" id="claim" placeholder="35W899112" /><span class="err"><form:errors path="Lettertopatients.claim"></form:errors></span></td>
              </tr>
              </table>
               <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="120"><span class="err">*</span>DOI:</td>
              <td ><input type="text" class="input_txtbx1" name="doi" id="datepicker" placeholder="05-26-02" /><span class="err"><form:errors path="Lettertopatients.doi"></form:errors></span></td>
              </tr>
              </table>
               <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
             ...
             <td>
              ...
              <tr> <td width="600"></td> <td>
              <b><span class="err">*</span>Darrin A. Pordash D.C.</b></td></tr>
              <tr> <td width="600"></td>  <td><input type="text" class="input_txtbx1" name="sign" id="sign" value="${letterto.sign }"/>.<span class="err"><form:errors path="Lettertopatients.sign"></form:errors> </span>
       		</td></tr>
       		 </table>
