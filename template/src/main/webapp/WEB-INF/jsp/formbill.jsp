...
<table cellpadding="0" cellspacing="0" border="0"  width="70%" class="margin_table">
 ...
 <table cellpadding="0" cellspacing="0" border="0" width="50%" class="margin_table" style="width: 583px; "><tr><td>
              ...
              <td><input type="text" class="input_txtbx1" name="address2" id="address2"><span class="err"><form:errors path="Formbill.address2"></form:errors></span></td>
              </tr>
              </table>
              <br>  
              	<table align="center" cellpadding="0" cellspacing="0" border="0"   width="70%"  ">
              ...
              <tr>
              <td style="width: 212px; "><span class="err"></span>  </td>
              <td><input type="text" class="input_txtbx1" name="address4" id="address4"><span class="err"><form:errors path="Formbill.address4"></form:errors></span></td>
              </tr>
              </table>
              <br>  
              ...
              <tr>
              <td style="width: 212px; "><span class="err"></span></td>
              <td><input type="text" class="input_txtbx1" name="address6" id="address6"><span class="err"><form:errors path="Formbill.address6"></form:errors></span></td>
              </tr>
              </table>
              <br>        
