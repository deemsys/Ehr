...
Canton, Ohio 44708
              ...
              <td ><input type="hidden" name="perryid" value="${perrychiropracticdetails.perryid }"><c:out value="${perrychiropracticdetails.insurance}"/></td>
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="50%"><span class="err"></span>Address:</td>
              <td ><c:out value="${perrychiropracticdetails.address}"/></td>
              </tr>
              </table>
               <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="50%"><span class="err"></span></td>
              <td ><c:out value="${perrychiropracticdetails.address1}"/></td>
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="50%"><span class="err"></span>Regarding:</td>
              <td ><c:out value="${perrychiropracticdetails.reg}"/></td>
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="50%"><span class="err"></span>Patient's Name/ Name of Person Entitled To Coverage: </td>
              <td ><c:out value="${perrychiropracticdetails.nameofperson}"/></td>
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="50%"><span class="err"></span>Date of Accident: </td>
              <td ><c:out value="${perrychiropracticdetails.dateofaccident}"/></td>
              </tr>
              </table>
