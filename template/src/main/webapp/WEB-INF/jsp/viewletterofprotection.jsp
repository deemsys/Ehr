			      ...
			      <form action="physicalexam" method="POST"> 
				     ...
				     <tr class="title">
								...
								<td valign="top" align="left" width="10%">Letter ID</td>
					         	...
					         	<td valign="top" align="left" width="10%">My Client</td>
						...
						<c:if test="${fn:length(letterofprotectionform.letterofprotectiondetails) gt 0}">
        				 <c:forEach items="${letterofprotectionform.letterofprotectiondetails}" var="letterofprotectiondetails" varStatus="status">
								            ...
								            <td valign="top" align="left"  width="10%"> <a href="letterofprotectionlist?letterid=${letterofprotectiondetails.letterid}"> ${letterofprotectiondetails.date}</td>
											
											<td valign="top" align="left" width="10%">${letterofprotectiondetails.myclient}</td>
											...
											<a href="#" title=""><img src="resources/images/icons/icon_delete.png" alt="Delete" /></a><a href=" <c:out value="deleteletterofprotection?letterid=${letterofprotectiondetails.letterid}"/>" onclick="return confirmation() ">Remove</a>
											</td>
