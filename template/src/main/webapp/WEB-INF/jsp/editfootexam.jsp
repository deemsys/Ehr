...
<td valign="top" align="left">
 <div>
        ...
        </td><td><input type="submit" value="Update" class="submit_btn" onclick="return checkSubmit1('this');"></td><td> <a href="viewfootexam" style="color: white" class="submit_btn" onclick="myclose()">Cancel</a></td></tr></table>
