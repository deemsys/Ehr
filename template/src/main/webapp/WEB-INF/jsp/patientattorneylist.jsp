      ...
      <tr>
        <td valign="top" align="center">
        	...
        	<c:set value="${patientattorneyform.patientattorneydetails[0]}" var="patientattorneydetails"> </c:set>
              ...
              <td ><input type="hidden" name="patientid" value="${patientattorneydetails.patientid }"><c:out value="${patientattorneydetails.name}"/></td>
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="120"><span class="err"></span>Address</td>
              <td ><c:out value="${patientattorneydetails.address}"/></td>
              </tr>
              </table>
              ...
              <td ><c:out value="${patientattorneydetails.reg}"/></td>
              </tr>
              </table>
              ...
              <td ><c:out value="${patientattorneydetails.patientname}"/></td>
              </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
              <td height="25" width="120"><span class="err"></span>Date of Accident</td>
              <td ><c:out value="${patientattorneydetails.date}"/></td>
              </tr>
              </table>
...
Dear Madam or Sir:
  ...
  <p><c:out value="${patientattorneydetails.dearsir}"/>. </p>	
...
Opinion 2007-7 provides the following further ethical directions: 
             ...
             <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <tr ><td width="70%"></td><td><c:out value="${patientattorneydetails.nameofclinic}"/></td></tr>
              <tr><td></td><td>Name of Clinic</td>
              </tr>
              
               <tr ><td width="70%"></td><td><c:out value="${patientattorneydetails.treat}"/></td></tr>
