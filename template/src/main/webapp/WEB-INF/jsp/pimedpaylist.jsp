...
<table cellpadding="0" cellspacing="0" border="0" width="70%" class="margin_table">
 ...
 <table cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <td ><input type="hidden" name="medpayid" value="${pimedpaydetails.medpayid }"><c:out value="${pimedpaydetails.insurance}"/></td>
              </tr>
              </table>
              ...
              <td><c:out value="${pimedpaydetails.address}"/></td>
              </tr>
              </table>
              <br>
               <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <td><c:out value="${pimedpaydetails.reg}"/></td>
              </tr>
              </table>
              ...
              <td><c:out value="${pimedpaydetails.nameofperson}"/></td>
              </tr>
              </table>
              <br>
               <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <td><c:out value="${pimedpaydetails.dateofaccident}"/></td>
              </tr>
              </table><br><br>
             ...
             <table>
             <tr><td><br><br><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	       <c:out value="${pimedpaydetails.subject}"/>  has sought and received medical treatment from this clinic.  Our patient made an assignment over to us of med pay proceeds to which we are entitled to receive from your company. You have received notice of this assignment by certified mail.
