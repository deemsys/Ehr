...
<td><textarea rows="5" cols="50" name="note" ><c:out value="${footexamdetails.note}"></c:out></textarea></td>	
	...
	<table  style="border:10">      
         ...
         <tr height="10"></tr>
         <tr><td>Plantar Flexion:		</td><td>50</td><td><input type="text" size="5" name="plantarflexionleft" value="${footexamdetails.plantarflexionleft}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" name="plantarflexionright" value="${footexamdetails.plantarflexionright}" onkeypress="return isNumberKey(event);"></td><td width="210"></td><td>Tinel's Tap:	</td><td width="150"></td><td><input size="5" type="text" value="${footexamdetails.tinelstapleft}" name="tinelstapleft">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="5" value="${footexamdetails.tinelstapright}" name="tinelstapright"></td></tr>
         <tr><td>Dorsiflexion:				</td><td>20</td><td><input size="5" type="text" name="dorsiflexionleft" value="${footexamdetails.dorsiflexionleft}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${footexamdetails.dorsiflexionright}" name="dorsiflexionright" onkeypress="return isNumberKey(event);"></td><td width="90"></td><td>Achilles Tap:</td><td width="150"></td><td><input type="text"  size="5" name="achillestapleft" value="${footexamdetails.achillestapleft}">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="5"  name="achillestapright" value="${footexamdetails.achillestapright}"></td></tr>
         <tr><td>Inversion:				</td><td>35</td><td><input size="5" type="text"  value="${footexamdetails.inversionleft}" name="inversionleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input  size="5" type="text" value="${footexamdetails.inversionright}" name="inversionright" onkeypress="return isNumberKey(event);"></td><td width="90"></td><td>Long / Transv Arch:</td><td width="150"></td><td><input type="text" size="5" value="${footexamdetails.longleft}"  name="longleft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text"  value="${footexamdetails.longright}" name="longright"></td></tr>
         <tr><td>Eversion:					</td><td>15</td><td><input size="5" type="text" value="${footexamdetails.eversionleft}" name="eversionleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text"  value="${footexamdetails.eversionright}" name="eversionright" onkeypress="return isNumberKey(event);"></td><td width="90"></td><td>Thompson's:	</td><td width="150"></td><td><input type="text" size="5"  name="thompsonsleft" value="${footexamdetails.thompsonsleft}">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${footexamdetails.thompsonsright}" name="thompsonsright"></td></tr></tr>
         <tr><td>Great Toe Extension:</td><td>70</td><td><input type="text" size="5" value="${footexamdetails.greattoeextensionleft}" name="greattoeextensionleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${footexamdetails.greattoeextensionright}" name="greattoeextensionright" onkeypress="return isNumberKey(event);"><td width="90"></td><td>Drawer:		</td><td width="150"></td><td><input type="text" size="5" value="${footexamdetails.drawerleft}" name="drawerleft">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="5" value="${footexamdetails.drawerright}" name="drawerright"></td></td></tr>
         <tr><td>Great Toe Flexion:	</td><td>45</td><td><input type="text" size="5" value="${footexamdetails.greattoeflexionleft}" name="greattoeflexionleft" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${footexamdetails.greattoeflexionright}" name="greattoeflexionright" onkeypress="return isNumberKey(event);"></td><td width="90"></td><td>Lateral (Varus) Stability:</td><td width="150"></td><td><input type="text" size="5" value="${footexamdetails.lateralleft}" name="lateralleft">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${footexamdetails.lateralright}"  name="lateralright"></td></tr>
          <tr><td></td><td></td><td>&nbsp;&nbsp;</td><td width="90"></td><td>Medial (Valgus) Stability:</td><td width="150"></td><td><input type="text" size="5"  name="medialstabilityleft" value="${footexamdetails.medialstabilityleft}">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="5" name="medialstabilityright" value="${footexamdetails.medialstabilityright}"></td></tr>
         </table>
         </td></tr></table></div></div>
        <div id="tabs-2">     
 ...
 <div>
        ...
        <tr>
         ...
         <td width="246"><input type="checkbox"   <c:if test="${footexamdetails.neurological=='Neurological Testing Unremarkable'}"> <c:out value="checked=checked"></c:out></c:if> id=neurologicalunremarkable name="neurological" value="Neurological Testing Unremarkable">Neurological Testing Unremarkable</td>
          ...
          <tr height="10"></tr>
           <tr><td>L1</td><td><input type="text"  size="5" name="inguinalarealeft" value="${footexamdetails.inguinalarealeft}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" name="inguinalarearight" value="${footexamdetails.inguinalarearight}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp; (Inguinal area)</td><td>L1</td><td><input size="5" type="text" name="iliopsoasfirstleft" value="${footexamdetails.iliopsoasfirstleft}" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"  size="5" value="${footexamdetails.iliopsoasfirstright}" name="iliopsoasfirstright" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp; (Iliopsoas)</td><td></td><td></td></tr>
           <tr><td>L2</td><td><input size="5" type="text" name="antleft" value="${footexamdetails.antleft}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" name="antright" value="${footexamdetails.antright}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;(Ant/med thigh)</td><td>L2</td><td><input type="text"  value="${footexamdetails.iliopsoas1left}" name="iliopsoas1left" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${footexamdetails.iliopsoas1right}" name="iliopsoas1right" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Iliopsoas)</td><td></td><td>&nbsp;(2+/5 is Normal)</td></tr>
           <tr><td>L3</td><td><input type="text" name="kneeleft" size="5" value="${footexamdetails.kneeleft}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" name="kneeright" value="${footexamdetails.kneeright}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;(Medial knee)</td><td>L3</td><td><input type="text" value="${footexamdetails.kneeextensionleft}" name="kneeextensionleft" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${footexamdetails.kneeextensionright}" name="kneeextensionright" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Knee extension)</td><td></td><td>&nbsp; </td></tr>
           <tr><td>L4</td><td><input type="text" size="5" name="medialleft" value="${footexamdetails.medialleft}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input  size="5"type="text" name="medialright" value="${footexamdetails.medialright}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;(Medial leg)</td><td>L4</td><td><input type="text" value="${footexamdetails.kneeflexionleft}" name="kneeflexionleft" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text"  value="${footexamdetails.kneeflexionright}"name="kneeflexionright" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Knee flexion)</td><td>L4</td><td><input type="text" name="patellarleft" size="5" value="${footexamdetails.patellarleft}" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"  value="${footexamdetails.patellarright}"name="patellarright" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;Patellar</td></tr>
            <tr><td>L5</td><td><input type="text" size="5" name="latleft" value="${footexamdetails.latleft}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="5" name="latright" value="${footexamdetails.latright}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;(Ant/lat leg)</td><td>L5</td><td><input type="text" name="dorsiflexionleft1" value="${footexamdetails.dorsiflexionleft1}" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5"  type="text"  value="${footexamdetails.dorsiflexionright1}" name="dorsiflexionright1" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Dorsiflexion)</td><td>L5</td><td><input type="text" name="hsleft" size="5" value="${footexamdetails.hsleft}" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="hsright"  value="${footexamdetails.hsright}" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;Med HS</td></tr>
            <tr><td>S1</td><td><input size="5" type="text" name="plantarleft" value="${footexamdetails.plantarleft}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" name="plantarright" value="${footexamdetails.plantarright}" onkeypress="return isNumberKey(event);">&nbsp;&nbsp;(Big toe/plantar)</td><td>S1</td><td><input type="text" name="pfleft" value="${footexamdetails.pfleft}" size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input  size="5"type="text"  value="${footexamdetails.pfright}"name="pfright" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;(Grt toe ext, PF)</td><td>S1</td><td><input type="text" name="achillesleft"  value="${footexamdetails.achillesleft}"size="5" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;&nbsp;&nbsp;<input size="5" type="text" value="${footexamdetails.achillesright}" name="achillesright" onkeypress="return isNumberKey(event);">/5&nbsp;&nbsp;Achilles</td></tr>
